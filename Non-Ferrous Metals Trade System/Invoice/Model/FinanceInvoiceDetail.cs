...
// 文件名：FinanceInvoiceDetail.cs
// 文件功能描述：财务发票明细dbo.Inv_FinanceInvoiceDetail实体类。
// 创建人：CodeSmith
// 创建时间： 2014年8月25日
----------------------------------------------------------------*/
...
{
	/// <summary>
	/// 财务发票明细dbo.Inv_FinanceInvoiceDetail实体类。
	/// </summary>
	[Serializable]
	public class FinanceInvoiceDetail : IModel
	{
		#region 字段
        ...
        private string tableName = "dbo.Inv_FinanceInvoiceDetail";
		#endregion
...
public DateTime LastModifyTime{get;set;}
        ...
        private string dalName = "NFMT.Funds.DAL.FinanceInvoiceDetailDAL";
