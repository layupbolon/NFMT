...
{
    /// <summary>
    /// SubStockInListHandler 的摘要说明
    /// </summary>
    public class SubStockInListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetSubStockLogsSelect(pageIndex, pageSize, orderStr, stockName, fromDate, toDate);
