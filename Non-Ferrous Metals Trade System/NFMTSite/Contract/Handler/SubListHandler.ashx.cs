...
{
    /// <summary>
    /// SubListHandler 的摘要说明
    /// </summary>
    public class SubListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = subBLL.GetListSelect(pageIndex, pageSize, orderStr, contractNo, outerCorp, status, beginDate, endDate);
