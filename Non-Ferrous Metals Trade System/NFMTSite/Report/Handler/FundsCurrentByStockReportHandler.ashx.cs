...
{
    /// <summary>
    /// FundsCurrentByStockReportHandler 的摘要说明
    /// </summary>
    public class FundsCurrentByStockReportHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetFundsCurrentByStockReportSelect(pageIndex, pageSize, orderStr, inCorp, outCorp, startDate, endDate);
