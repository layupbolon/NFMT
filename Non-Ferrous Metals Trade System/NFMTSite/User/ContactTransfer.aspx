<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactTransfer.aspx.cs" Inherits="NFMTSite.User.ContactTransfer" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlEmpStatus").jqxDropDownList({ source: dataAdapter, displayMember: "StatusName", valueMember: "StyleDetailId", selectedIndex: 0, width: 100, height: 25, autoDropDownHeight: true });
            ...
            var url = "Handler/EmpListHandler.ashx?empCode=" + empCode + "&name=" + name + "&workStatus=" + workStatus;
            var formatedData = "";
            var totalrecords = 0;
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"ContactTransferDetail.aspx?id=" + value + "\">选择转移员工</a>";
                cellHtml += "</div>";
                return cellHtml;
            }
            ...
            $("#btnSearch").click(function () {
                ...
                var name = $("#txbName").val();
                var workStatus = $("#ddlEmpStatus").val();
                source.url = "Handler/EmpListHandler.ashx?empCode=" + empCode + "&name=" + name + "&workStatus=" + workStatus;
