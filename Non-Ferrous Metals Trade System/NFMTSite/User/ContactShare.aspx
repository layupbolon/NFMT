<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactShare.aspx.cs" Inherits="NFMTSite.User.ContactShare" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/EmpListExceptHandler.ashx?empCode=" + empCode + "&name=" + name + "&workStatus=" + workStatus + "&excepteEmpId=" + "<%=this.curUserId%>";
            var formatedData = "";
            var totalrecords = 0;
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"ContactShareDetail.aspx?id=" + value + "\">选择员工</a>";
                cellHtml += "</div>";
                return cellHtml;
            }
