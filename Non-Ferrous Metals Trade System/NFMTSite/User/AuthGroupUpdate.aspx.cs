...
{
    public partial class AuthGroupUpdate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ver.JudgeOperate(this.Page, 99, new List<NFMT.Common.OperateEnum>() { NFMT.Common.OperateEnum.修改 });
                ...
                this.navigation1.Routes.Add("权限组修改", string.Empty);
