<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptUpdate.aspx.cs" Inherits="NFMTSite.User.DeptUpdate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlDeptType").jqxDropDownList("val", $("#hidDeptType").val());
            ...
            //var deptLevel = $("#hidDeptLevel").val();
            //$("#ddlDeptLevel").jqxDropDownList("val", deptLevel);

            //绑定 上级部门名称
            var url = "Handler/DeptDDLHandler.ashx";
            var source = { datatype: "json", datafields: [{ name: "DeptId" }, { name: "DeptName" }], url: url, async: false };
            var dataAdapter = new $.jqx.dataAdapter(source);
            $("#ddlParentDeptName").jqxComboBox({ selectedIndex: 0, source: dataAdapter, displayMember: "DeptName", valueMember: "DeptId", width: 200, height: 25, autoDropDownHeight: true });
            var obj = { DeptName: " ", DeptId: 0 };
            $("#ddlParentDeptName").jqxComboBox("insertAt", obj, 0);
            if ($("#hidParentDeptId").val() > 0) { $("#ddlParentDeptName").jqxComboBox("val", $("#hidParentDeptId").val()); }
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/DeptUpdateHandler.ashx", {
                    CorpId: corpId,
                    DeptCode: deptCode,
                    DeptName: deptName,
                    ...
                    function (result) {
                        ...
                        //$("#ddlDeptLevel").val("");
                        window.document.location = "DepartmentList.aspx";
                    }
                );
            });
        });
