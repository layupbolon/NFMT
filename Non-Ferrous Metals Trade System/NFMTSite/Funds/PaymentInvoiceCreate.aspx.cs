...
{
    public partial class PaymentInvoiceCreate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.navigation1.Routes.Add("财务付款新增--发票关联", string.Empty);
        ...
        public void SelectJson(int payApplyId)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetInvoiceCreateSelect(pageIndex, pageSize, orderStr, payApplyId);
