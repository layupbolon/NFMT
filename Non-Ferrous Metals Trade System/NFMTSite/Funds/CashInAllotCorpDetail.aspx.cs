...
{
    public partial class CashInAllotCorpDetail : System.Web.UI.Page
    {
        public NFMT.Funds.Model.CashInAllot curAllot = new NFMT.Funds.Model.CashInAllot();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ver.JudgeOperate(this.Page, 56, new List<NFMT.Common.OperateEnum>() { NFMT.Common.OperateEnum.提交审核, NFMT.Common.OperateEnum.作废, NFMT.Common.OperateEnum.撤返, NFMT.Common.OperateEnum.执行完成, NFMT.Common.OperateEnum.执行完成撤销,NFMT.Common.OperateEnum.关闭 });

                this.navigation1.Routes.Add("公司收款分配", redirectUrl);
                this.navigation1.Routes.Add("公司收款分配明细", string.Empty);
