<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashInAllotStockList.aspx.cs" Inherits="NFMTSite.Funds.CashInAllotStockList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //绑定Grid
            var url = "Handler/CashInAllotStockListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
                ...
                type: "GET",
                sortcolumn: "cisr.AllotId",
                sortdirection: "desc",
                formatdata: function (data) {
                    data.pagenum = data.pagenum || 0;
                    data.pagesize = data.pagesize || 10;
                    data.sortdatafield = data.sortdatafield || "cisr.AllotId";
            ...
            $("#btnSearch").click(function () {
                source.url = "Handler/CashInAllotContractListHandler.ashx";
