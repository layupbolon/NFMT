<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashInList.aspx.cs" Inherits="NFMTSite.Funds.CashInList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //收款状态
            CreateStatusDropDownList("ddlCashInStatus");
            ...
            //绑定Grid
            var url = "Handler/CashInListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"CashInDetail.aspx?id=" + value + "\">明细</a>";
                if (item.CashInStatus > statusEnum.已作废 && item.CashInStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"CashInUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#btnSearch").click(function () {
                ...
                var status = $("#ddlCashInStatus").val();
                var bank = $("#ddlCashInBank").val();
                source.url = "Handler/CashInListHandler.ashx?f=" + dateBegin + "&t=" + dateEnd + "&e=" + empId + "&s=" + status + "&b=" + bank;
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <div id="ddlCashInStatus" style="float: left;"></div>
                </li>
                <li>
                    <input type="button" id="btnSearch" value="查询" />
                    <a target="_self" runat="server" href="CashInCreate.aspx" id="btnAdd">收款登记</a>
                </li>
            </ul>
        </div>
    </div>
