<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractReceivableReadyContractList.aspx.cs" Inherits="NFMTSite.Funds.ContractReceivableReadyContractList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //Grid
            var url = "Handler/CanAllotContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return "<div style=\"overflow: hidden; text-overflow: ellipsis; padding-bottom: 2px; text-align: center; margin-right: 2px; margin-left: 4px; margin-top: 4px;\">"
                   + "<a target=\"_self\" href=\"ContractReceivableCreate.aspx?id=" + value + "\">分配</a>"
                   + "</div>";
            }
            $("#jqxGrid").jqxGrid(
            {
