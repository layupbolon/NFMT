...
{
    public partial class PaymentInvoiceDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ver.JudgeOperate(this.Page, 53, new List<NFMT.Common.OperateEnum>() { NFMT.Common.OperateEnum.提交审核, NFMT.Common.OperateEnum.作废, NFMT.Common.OperateEnum.撤返, NFMT.Common.OperateEnum.确认完成, NFMT.Common.OperateEnum.确认完成撤销, NFMT.Common.OperateEnum.关闭 });

                string redirectUrl = "PaymentList.aspx";

                this.navigation1.Routes.Add("财务付款列表", redirectUrl);
                this.navigation1.Routes.Add("财务付款明细--发票关联", string.Empty);
                ...
                string json = serializer.Serialize(this.curPayment);
