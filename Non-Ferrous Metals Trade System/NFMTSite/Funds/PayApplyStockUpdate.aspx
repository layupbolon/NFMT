<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayApplyStockUpdate.aspx.cs" Inherits="NFMTSite.Funds.PayApplyStockUpdate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            stockListSource =
            {
                ...
                url: "Handler/PayApplyStockListHandler.ashx?sids="+"<%=this.Sids%>"
            };
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("Handler/PayApplyStockUpdateHandler.ashx", { PayApply: JSON.stringify(payApply), Stocks: stocks, memo: $("#txbMemo").val(), deptId: $("#selApplyDept").val(), corpId: $("#selApplyCorp").jqxComboBox("val") },
                    function (result) {
