...
{
    /// <summary>
    /// CashInContractLastListHandler 的摘要说明
    /// </summary>
    public class CashInContractLastListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string stockRefIds = context.Request.QueryString["stockRefIds"];
            int currencyId = 0;
            ...
            {
                context.Response.Write("合约序号错误");
                context.Response.End();
            }

            NFMT.Funds.BLL.CashInContractBLL bll = new NFMT.Funds.BLL.CashInContractBLL();
            NFMT.Common.SelectModel select = bll.GetContractAllotLastSelect(pageIndex, pageSize, orderStr, contractRefIds, stockRefIds, subId, currencyId);
