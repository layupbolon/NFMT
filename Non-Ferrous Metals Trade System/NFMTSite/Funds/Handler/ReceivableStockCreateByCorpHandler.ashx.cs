...
{
    /// <summary>
    /// ReceivableStockCreateByCorpHandler 的摘要说明
    /// </summary>
    public class ReceivableStockCreateByCorpHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.ReceivableStockCreateByCorpHandle(user, contractReceivables, curId, memo, allotFrom, stockId, stockNameId);
            }
            catch (Exception e)
            {
