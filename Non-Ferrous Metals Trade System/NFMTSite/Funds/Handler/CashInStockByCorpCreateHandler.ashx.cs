...
{
    /// <summary>
    /// CashInStockByCorpCreateHandler 的摘要说明
    /// </summary>
    public class CashInStockByCorpCreateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                List<NFMT.Funds.Model.CashInContract> contracts = serializer.Deserialize<List<NFMT.Funds.Model.CashInContract>>(detailStr);
                if (contracts == null)
                {
                ...
                result = bll.CreateContractStock(user, allot, contracts, stockLogId);
            }
            catch (Exception e)
            {
