...
{
    /// <summary>
    /// PayApplyMulityStockListHandler 的摘要说明
    /// </summary>
    public class PayApplyMulityStockListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string subIds = context.Request.QueryString["subIds"];
            ...
            NFMT.Common.SelectModel select = bll.GetLogsBySubIdsSelect(pageIndex, pageSize, orderStr, subIds, logIds, refIds);
