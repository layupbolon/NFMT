...
{
    /// <summary>
    /// ContractReceByCorpAllotCreateHandler 的摘要说明
    /// </summary>
    public class ContractReceByCorpAllotCreateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.ReceivableCorpAllotCreateHandle(user, contractReceivables, curId, memo, allotFrom);
            }
            catch (Exception e)
            {
