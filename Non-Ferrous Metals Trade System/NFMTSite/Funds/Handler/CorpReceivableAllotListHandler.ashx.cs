...
{
    /// <summary>
    /// CorpReceivableAllotListHandler 的摘要说明
    /// </summary>
    public class CorpReceivableAllotListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetCorpCanAllotSelectModel(pageIndex, pageSize, orderStr, refIds, subId);
