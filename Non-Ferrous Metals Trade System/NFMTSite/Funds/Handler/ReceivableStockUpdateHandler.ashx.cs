...
{
    /// <summary>
    /// ReceivableStockUpdateHandler 的摘要说明
    /// </summary>
    public class ReceivableStockUpdateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.ReceivableStockUpdateHandle(user, corpReceivables, curId, memo, allotId, sid, stockNameId, allotFrom);
