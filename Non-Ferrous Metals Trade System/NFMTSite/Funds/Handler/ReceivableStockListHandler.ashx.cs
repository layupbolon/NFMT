...
{
    /// <summary>
    /// ReceivableStockListHandler 的摘要说明
    /// </summary>
    public class ReceivableStockListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetReceStockSelectModel(pageIndex, pageSize, orderStr, empId, status);
