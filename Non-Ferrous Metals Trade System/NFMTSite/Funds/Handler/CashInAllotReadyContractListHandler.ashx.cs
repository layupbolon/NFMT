...
{
    /// <summary>
    /// CashInAllotReadyContractListHandler 的摘要说明
    /// </summary>
    public class CashInAllotReadyContractListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetAllotReadyContractListSelect(pageIndex, pageSize, orderStr, contractNo, outerCorp, beginDate, endDate);
