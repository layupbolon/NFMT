...
{
    /// <summary>
    /// PayApplyMultyCreateHandler 的摘要说明
    /// </summary>
    public class PayApplyMultyCreateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.PayApplyMultiCreate(user, apply, payApply, stockDetails, isAudit);
