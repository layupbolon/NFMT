...
{
    /// <summary>
    /// CashInAllotReadyStockListHandler 的摘要说明
    /// </summary>
    public class CashInAllotReadyStockListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetAllotReadyStockSelect(pageIndex, pageSize, orderStr, status, subNo);
