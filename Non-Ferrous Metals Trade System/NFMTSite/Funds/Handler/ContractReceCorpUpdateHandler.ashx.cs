...
{
    /// <summary>
    /// ContractReceCorpUpdateHandler 的摘要说明
    /// </summary>
    public class ContractReceCorpUpdateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.ReceAllotCorpUpdateHandle(user, contractReceivables, curId, memo, allotId, contractId, subId);
