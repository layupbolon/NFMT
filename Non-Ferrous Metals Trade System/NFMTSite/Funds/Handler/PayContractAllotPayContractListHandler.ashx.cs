...
{
    /// <summary>
    /// PayContractAllotPayContractListHandler 的摘要说明
    /// </summary>
    public class PayContractAllotPayContractListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string status = context.Request.QueryString["s"];
