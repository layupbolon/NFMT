...
{
    /// <summary>
    /// ContractReceivableUpdateHandler 的摘要说明
    /// </summary>
    public class ContractReceivableUpdateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.ReceivableAllotUpdateHandle(user, corpReceivables, curId, memo, allotId, contractId, subId);
