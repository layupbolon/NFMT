...
{
    /// <summary>
    /// PayContractAllotToStockCanSelectStockHandler 的摘要说明
    /// </summary>
    public class PayContractAllotToStockCanSelectStockHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetLogsBySubIdSelect(pageIndex, pageSize, orderStr, subId, logIds);
