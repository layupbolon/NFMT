<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashInAllotCorpCreate.aspx.cs" Inherits="NFMTSite.Funds.CashInAllotCorpCreate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var otherSource =
            {
                ...
                url: "Handler/CashInCorpOtherAllotListHandler.ashx?cid=" + "<%=this.curCorp.CorpId%>"
            };
            ...
            allotSource =
            {
                ...
                url: "Handler/CashInLastListHandler.ashx"
            };
                ...
                columns: [
                  ...
                  { text: "剩余金额", datafield: "LastBala", editable: false },
                  {
                      text: "分配金额", datafield: "AllotBala", columntype: "numberinput", cellclassname: "GridFillNumber", validation: function (cell, value) {
                          var item = $("#jqxAllotGrid").jqxGrid("getrowdata", cell.row);
            ...
            $("#btnCreate").click(function () {
                ...
                if (!confirm("确认新增收款分配？")) { return; }

                var rows = $("#jqxSelectGrid").jqxGrid("getrows");

                $.post("Handler/CashInAllotCorpCreateHandler.ashx", {
                    Details: JSON.stringify(rows),
                    Memo: $("#txbMemo").val(),
                    CorpId: "<%=this.curCorp.CorpId%>",
