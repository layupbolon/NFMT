...
namespace NFMTSite.Control
{
    public partial class Attach : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (this.AttachStyle == Utility.AttachStyleEnum.修改)
            {
                sb.AppendLine("<div id=\"jqxAttachGrid\"></div>");
                sb.AppendLine("<div>");
                sb.AppendLine("<ul id=\"ulAttach\">");
        ...
        private Utility.AttachStyleEnum attachStyle = Utility.AttachStyleEnum.查看;
        public Utility.AttachStyleEnum AttachStyle
        {
