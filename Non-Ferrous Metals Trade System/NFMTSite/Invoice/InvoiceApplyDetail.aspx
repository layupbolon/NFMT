        ...
        $(document).ready(function () {
            ...
            $("#jqxApplyGrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "外部合约号", datafield: "OutContractNo", width: "8%" },
                  { text: "卡号", datafield: "CardNo", width: "7%" },
                  { text: "客户", datafield: "CorpName", width: "12%" },
                  { text: "品种", datafield: "AssetName", width: "6%" },
                  {
                      text: "净重", datafield: "NetAmount", width: "10%", aggregates: [{
                          '<b>总</b>':
                  ...
                  { text: "单位", datafield: "MUName", width: "4%" },
                  { text: "价格", datafield: "InvoicePrice", width: "7%", cellsrenderer: cellsrenderer },
                  { text: "货款金额", datafield: "PaymentAmount", width: "13%", cellsrenderer: cellsrenderer },
                  ...
                  {
                      text: "开票金额", datafield: "InvoiceBala", width: "13%", cellsrenderer: cellsrenderer, aggregates: [{
                          '<b>总</b>':
                                    function (aggregatedValue, currentValue, column, record) {
                                        return Math.round((aggregatedValue + currentValue) * 100) / 100;
                                    }
                      }]
                  }
                ]
