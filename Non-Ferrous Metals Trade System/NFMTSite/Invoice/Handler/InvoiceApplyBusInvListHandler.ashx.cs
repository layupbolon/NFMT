...
{
    /// <summary>
    /// InvoiceApplyBusInvListHandler 的摘要说明
    /// </summary>
    public class InvoiceApplyBusInvListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string subNo = context.Request.QueryString["cno"];
            ...
            NFMT.Common.SelectModel select = bll.GetCanApplyBISelectModel(pageIndex, pageSize, orderStr, assetId, customerCorpId, subNo);
