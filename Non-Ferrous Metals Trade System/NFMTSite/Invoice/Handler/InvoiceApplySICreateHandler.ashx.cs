...
{
    /// <summary>
    /// InvoiceApplySICreateHandler 的摘要说明
    /// </summary>
    public class InvoiceApplySICreateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                List<NFMT.Invoice.Model.InvoiceApplySIDetail> details = serializer.Deserialize<List<NFMT.Invoice.Model.InvoiceApplySIDetail>>(rowsStr);
                ...
                result = bll.CreateSIApply(user, apply, details, isSubmitAudit);
