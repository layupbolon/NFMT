...
{
    /// <summary>
    /// InvoiceApplyUpdateInfoHandler 的摘要说明
    /// </summary>
    public class InvoiceApplyUpdateInfoHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetUpdateSelectModel(pageIndex, pageSize, orderStr, invoiceApplyId, detailIds);
