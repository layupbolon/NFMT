...
{
    /// <summary>
    /// InvoiceSuppleFinalListHandler 的摘要说明
    /// </summary>
    public class InvoiceSuppleFinalListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetSuppleFinalSelect(pageIndex, pageSize, orderStr, fromDate, toDate, status, inCorpId, outCorpId);
