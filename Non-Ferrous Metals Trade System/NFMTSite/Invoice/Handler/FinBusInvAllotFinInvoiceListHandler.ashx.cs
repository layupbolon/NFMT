...
{
    /// <summary>
    /// FinBusInvAllotFinInvoiceListHandler 的摘要说明
    /// </summary>
    public class FinBusInvAllotFinInvoiceListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(context.Request.QueryString["sortdatafield"]) && !string.IsNullOrEmpty(context.Request.QueryString["sortorder"]))
            {
                ...
                switch (sortDataField)
                {
                    ...
                    case "InCorpName":
                        ...
                        break;
                    case "VATRatio":
                        sortDataField = "fi.VATRatio";
                        break;
                    case "VATBala":
                        sortDataField = "fi.VATBala";
                        break;
                    case "StatusName":
            ...
            NFMT.Common.SelectModel select = bll.GetCanAllotSelectModel(pageIndex, pageSize, orderStr, fromDate, toDate, status, inCorpId, outCorpId);
