...
{
    /// <summary>
    /// InvoiceReplaceFinalListHandler 的摘要说明
    /// </summary>
    public class InvoiceReplaceFinalListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetReplaceFinalSelect(pageIndex, pageSize, orderStr, fromDate, toDate, status, inCorpId, outCorpId);
