...
{
    /// <summary>
    /// InvoiceBusinessListHandler 的摘要说明
    /// </summary>
    public class InvoiceBusinessListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetSelectModel(pageIndex, pageSize, orderStr, fromDate, toDate, status, inCorpId, outCorpId,NFMT.Invoice.InvoiceTypeEnum.DirectFinalInvoice);
