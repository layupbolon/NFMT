<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSuppleFinalUpdate.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceSuppleFinalUpdate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("Handler/InvoiceSuppleFinalUpdateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceBusiness: JSON.stringify(invoiceBusiness),Details:JSON.stringify(rows) },
                    function (result) {
