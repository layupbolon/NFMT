...
{
    public partial class FinBusInvAllotUpdate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ver.JudgeOperate(this.Page, 90, new List<NFMT.Common.OperateEnum>() { NFMT.Common.OperateEnum.修改 });
                ...
                this.navigation1.Routes.Add("财务发票分配修改", string.Empty);
