<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceDirectFinalDetail.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceDirectFinalDetail" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnInvalid").on("click", function () {
                ...
                $.post("Handler/InvoiceDirectFinalStatusHandler.ashx", { ii: "<%=this.curBusinessInvoice.BusinessInvoiceId%>", oi: operateId },
                    function (result) {
                        alert(result);
