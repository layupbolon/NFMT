<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalUpdate.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceProvisionalUpdate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("Handler/InvoiceProvisionalUpdateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceBusiness: JSON.stringify(invoiceBusiness),Details: JSON.stringify(rows) },
                    function (result) {
