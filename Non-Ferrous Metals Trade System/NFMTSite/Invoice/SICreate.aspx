<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SICreate.aspx.cs" Inherits="NFMTSite.Invoice.SICreate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //发票金额
            $("#nbInvoiceBala").jqxNumberInput({ height: 25, min: 0, decimalDigits: 2, width: 160, spinButtons: true, disabled: true });
            ...
            $("#ddlCurrencyId").jqxComboBox({
                source: cyDataAdapter, displayMember: "CurrencyName", valueMember: "CurrencyId", width: 100, height: 25, searchMode: "containsignorecase", selectedIndex: 1
            });
            ...
            $("#ddlChangeCurrencyId").jqxComboBox({ source: changecyDataAdapter, displayMember: "CurrencyName", valueMember: "CurrencyId", width: 100, height: 25, searchMode: "containsignorecase", selectedIndex: 1 });
            ...
            $("#ddlChangeRate").jqxNumberInput("val", 1);

            //折算金额, Digits: 3
            $("#nbChangeBala").jqxNumberInput({ height: 25, min: 0, decimalDigits: 2, symbolPosition: "right", spinButtons: true, width: 160 });

            //收票公司
            var outCorpUrl = "../User/Handler/CorpDDLHandler.ashx?isSelf=<%=this.outId%>";
            var outCorpSource = {
                datafields:
                [
            ...
            $("#ddlInnerCorp").jqxComboBox({ source: outCorpDataAdapter, displayMember: "CorpName", valueMember: "CorpId", height: 25, searchMode: "containsignorecase" });

            //开票公司
            var inCorpUrl = "../User/Handler/CorpDDLHandler.ashx?isSelf=<%=this.inId%>";
            var inCorpSource = {
                datafields:
                [
                    { name: "CorpId", type: "int" },
            ...
            //外部合约号
            $("#txbOutContractNo").jqxInput({ height: 23 });
            ...
            var source =
            {
                ...
                url: "Handler/SICreateStockListHandler.ashx?r=" + $("#txbRefNo").val() + "&outNo=" + $("#txbOutContractNo").val()
            };
            ...
            $("#btnSearch").click(function () {
                source.url = "Handler/SICreateStockListHandler.ashx?r=" + $("#txbRefNo").val() + "&outNo=" + $("#txbOutContractNo").val();
            ...
            function SICreate(isAudit) {
                ...
                $.post("Handler/SICreateHandler.ashx", {
                ...
                function (result) {
                    ...
                    if (obj.ResultStatus.toString() == "0") {
                        if (isAudit) {
                            AutoSubmitAudit(MasterEnum.价外票审核, JSON.stringify(obj.ReturnValue));
                        }
                    }
                    alert(obj.Message);
            ...
            $("#btnAudit").click(function () { SICreate(true); });
            $("#btnCreate").click(function () { SICreate(false); });
        });
...
<body>
        ...
        <div>
            <div class="SearchExpander">
                <ul>
                    ...
                    <li>
                        <span style="float: left;">外部合约号：</span>
                        <input type="text" id="txbOutContractNo" style="float: left;" />
                    </li>
                    <li>
    ...
    <div id="buttons" style="width: 80%; text-align: center;">
        ...
        <input type="button" id="btnCreate" value="新增价外票" style="width: 125px; height: 25px;" />&nbsp;&nbsp;&nbsp;&nbsp;
