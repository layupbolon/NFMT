<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirectFinalInvoiceList.aspx.cs" Inherits="NFMTSite.Invoice.DirectFinalInvoiceList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/DirectFinalInvoiceListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/DirectFinalInvoiceListHandler.ashx?s=" + status + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
        ...
        <div class="SearchExpander">
            <ul>                
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="DirectFinalInvoiceCreate.aspx" id="btnAdd">直接终票新增</a>
                </li>
            </ul>
        </div>
    </div>
