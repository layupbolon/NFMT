<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceApplySICreate.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceApplySICreate" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var upSource =
            {
                ...
                url: "Handler/InvoiceApplySISelectListHandler.ashx?sIIds=" + upSIIds
            };
                ...
                columns: [
                  ...
                  { text: "发票金额", datafield: "InvoiceBala" },
                  {
                      text: "操作", datafield: "Edit", columntype: "button", width: 90, cellsrenderer: function () {
                          ...
                          //刷新列表
                          upSource.url = "Handler/InvoiceApplySISelectListHandler.ashx?sIIds=" + upSIIds;
                          $("#jqxApplyGrid").jqxGrid("updatebounddata", "rows");

                          downSource.url = "Handler/InvoiceApplySISelectListHandler.ashx?sIIds=" + downSIIds;
            ...
            var downSource =
            {
                ...
                url: "Handler/InvoiceApplySISelectListHandler.ashx?sIIds=" + downSIIds
            };
            ...
            $("#btnCreate").click(function () { SIApplyCreate(false); });
            $("#btnAduit").jqxButton({ width: 180, height: 25 });
            $("#btnAduit").click(function () { SIApplyCreate(true); });
            $("#btnCancel").jqxLinkButton({ height: 25, width: 100 });

            function SIApplyCreate(isAudit) {
                ...
                if (!confirm("确定提交价外票开票申请？")) { return; }

                $("#btnCreate").jqxButton({ disabled: true });
                $("#btnAduit").jqxButton({ disabled: true });
                ...
                $.post("Handler/InvoiceApplySICreateHandler.ashx", {
                    ...
                    function (result) {
                        ...
                        if (obj.ResultStatus.toString() == "0") {
                            ...
                            $("#btnAduit").jqxButton({ disabled: false });
                        }
                    }
                );
            }
