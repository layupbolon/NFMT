...
{
    /// <summary>
    /// FinancingPledgeApplyListHandler 的摘要说明
    /// </summary>
    public class FinancingPledgeApplyListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string result = service.GetFinancingPledgeApplyList(pageIndex, pageSize, orderStr, beginDate, endDate, bankId, assetId, status, pledgeApplyNo, refNo);
