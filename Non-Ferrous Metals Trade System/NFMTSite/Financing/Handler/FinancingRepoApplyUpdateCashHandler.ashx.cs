...
{
    /// <summary>
    /// FinancingRepoApplyUpdateCashHandler 的摘要说明
    /// </summary>
    public class FinancingRepoApplyUpdateCashHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                resultStr = service.FinancingRepoApplyUpdateCash(userJson, rowsStr, repoApplyId);
            }
            catch (Exception e)
            {
