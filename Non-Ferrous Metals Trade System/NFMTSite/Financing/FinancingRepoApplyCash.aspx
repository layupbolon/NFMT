<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancingRepoApplyCash.aspx.cs" Inherits="NFMTSite.Financing.FinancingRepoApplyCash" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxCashGrid").jqxGrid(
            {
                ...
                enabletooltips: true,
                columns: [
                  { text: "实货合同号", datafield: "StockContractNo", width: "13%" },
                  {
                      text: "数量（手）", datafield: "Hands", width: "13%", aggregates: [{
                          '<b>总</b>':
                                    function (aggregatedValue, currentValue, column, record) {
                  ...
                  {
                      text: "价格", datafield: "Price", width: "13%", sortable: false, columntype: "numberinput",
                      createeditor: function (row, cellvalue, editor) {
                          editor.jqxNumberInput({ min: 0, decimalDigits: 4, width: 200, Digits: 8, spinButtons: true });
                      }
                  },
                  { text: "到期日", datafield: "ExpiringDate", width: "13%", cellsformat: "yyyy-MM-dd", columntype: "datetimeinput" },
        ...
        $(document).ready(function () {
            ...
            $("#jqxRepoGrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "赎回手数", datafield: "Hands",editable: false,width:"9%", aggregates: [{
                      '<b>总</b>':
                                function (aggregatedValue, currentValue, column, record) {
                                    return aggregatedValue + currentValue;
                                }
                  ...
                  {
                      text: "价格", datafield: "Price", width: "9%", sortable: false, columntype: "numberinput",
                      createeditor: function (row, cellvalue, editor) {
                          editor.jqxNumberInput({ min: 0, decimalDigits: 4, Digits: 8, spinButtons: true });
                      }
                  },
                  { text: "到期日", datafield: "ExpiringDate", width: "11%", cellsformat: "yyyy-MM-dd",columntype: "datetimeinput",initeditor: function (row, cellvalue, editor) {
                      editor.jqxDateTimeInput({formatString: "yyyy-MM-dd",value:new Date("<%=DateTime.Now%>") });
                  }
                  },
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnPass").on("click", function () {
                ...
                //    if (!rows[i].Price || rows[i].Price == 0 || !rows[i].ExpiringDate || rows[i].ExpiringDate == "") {
                //        alert("请填写期货头寸信息");
                //        return;
                //    }
                //}
