<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancingPledgeApplyList.aspx.cs" Inherits="NFMTSite.Financing.FinancingPledgeApplyList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlFinBank").jqxComboBox({ source: ddlBankdataAdapter, displayMember: "BankName", valueMember: "BankId", width: 120, height: 25, autoDropDownHeight: true });
            ...
            var url = "Handler/FinancingPledgeApplyListHandler.ashx?fromDate=" + fromDate + "&toDate=" + toDate + "&bankId=" + bank + "&assetId=" + asset + "&status=" + status + "&paNo=" + pledgeApplyNo + "&refNo=" + refNo;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value) {
                ...
                cellHtml += "<a target=\"_self\" href=\"FinancingPledgeApplyDetail.aspx?id=" + value + "\">查看</a>";

                if (item.PledgeApplyStatus > statusEnum.已关闭 && item.PledgeApplyStatus < statusEnum.待审核&&"<%=CanUpdate%>".toLowerCase()==="true") {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"FinancingPledgeApplyUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "融资银行", datafield: "BankName", width: "10%" },
                  { text: "融资银行账号", datafield: "AccountNo", width: "10%" },
                  { text: "融资货物", datafield: "AssetName", width: "8%" },
                  //{ text: "头寸是否转回", datafield: "SwitchBack", width: "10%" },
                  { text: "净重合计", datafield: "SumNetAmount", width: "11%" },
                  { text: "手数合计", datafield: "SumHands", width: "11%" },
                  //{ text: "单位", datafield: "MUName", width: "5%" },
                  { text: "审核环节", datafield: "NodeName" },
                  { text: "状态", datafield: "StatusName",width:"7%" },
                  { text: "操作", datafield: "PledgeApplyId", cellsrenderer: cellsrenderer, width: "7%", enabletooltips: false, sortable: false }
                ]
            });
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/FinancingPledgeApplyListHandler.ashx?fromDate=" + fromDate + "&toDate=" + toDate + "&bankId=" + bank + "&assetId=" + asset + "&status=" + status + "&paNo=" + pledgeApplyNo + "&refNo=" + refNo;
            ...
            $("#btnExport").click(function () {
                ...
                document.location.href = "../Report/ExportExcel.aspx?rt=357&fromDate=" + fromDate + "&toDate=" + toDate + "&bankId=" + bank + "&assetId=" + asset + "&status=" + status + "&paNo=" + pledgeApplyNo + "&refNo=" + refNo;
            });
        });
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="~/Financing/FinancingPledgeApplyCreate.aspx" id="btnAdd">新建质押申请单</a>
                </li>
            </ul>
        </div>
    </div>
