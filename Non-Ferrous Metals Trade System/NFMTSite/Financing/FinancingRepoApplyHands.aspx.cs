...
{
    public partial class FinancingRepoApplyHands : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                selectedJsonDown = service.GetFinRepoApplyStockDetailForHands(1, 500, "rad.StockDetailId desc", CurPledgeApply.PledgeApplyId, repoApplyId);
            }
        }
    }
}