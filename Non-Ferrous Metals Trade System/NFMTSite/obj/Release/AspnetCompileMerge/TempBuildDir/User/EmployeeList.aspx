<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeList.aspx.cs" Inherits="NFMTSite.User.EmployeeList" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"EmployeeDetail.aspx?id=" + value + "\">明细</a>";
                cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"EmployeeUpdate.aspx?id=" + value + "\">修改</a>";
                cellHtml += "</div>";
                return cellHtml;
            }
        ...
        <div id="SearchDiv">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="EmployeeCreate.aspx" id="btnAdd">新增员工</a>
                </li>
            </ul>
        </div>
    </div>
