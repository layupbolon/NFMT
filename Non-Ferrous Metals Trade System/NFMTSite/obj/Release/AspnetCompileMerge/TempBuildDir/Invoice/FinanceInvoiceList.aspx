<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceInvoiceList.aspx.cs" Inherits="NFMTSite.Invoice.FinanceInvoiceList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnInvApplyAdd").jqxLinkButton({ height: 25, width: 140 });
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"FinanceInvoiceDetail.aspx?id=" + value + "\">明细</a>";

                if (item.InvoiceStatus > statusEnum.已关闭 && item.InvoiceStatus < statusEnum.待审核) {
                    if (item.RefId > 0)
                        cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"FinanceInvoiceInvApplyUpdate.aspx?id=" + value + "\">修改</a>";
                    else
                        cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"FinanceInvoiceUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="FinanceInvoiceCreate.aspx?d=out" id="btnOutAdd">由业务票开财务票</a>
                    <a target="_self" runat="server" href="FinanceInvoiceCreate.aspx?d=in" id="btnInAdd">财务票收入</a>
                    <a target="_self" runat="server" href="FinanceInvoiceInvApplyList.aspx" id="btnInvApplyAdd">由开票申请开财务票</a>
                </li>
            </ul>
        </div>
    </div>
