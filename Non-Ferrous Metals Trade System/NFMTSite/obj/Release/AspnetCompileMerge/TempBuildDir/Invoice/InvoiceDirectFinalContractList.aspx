<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceDirectFinalContractList.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceDirectFinalContractList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {            
            ...
            var url = "Handler/InvoiceDirectFinalContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/InvoiceDirectFinalContractListHandler.ashx?sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
