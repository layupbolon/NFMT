<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalDetail.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceProvisionalDetail" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnInvalid").on("click", function () {
                ...
                $.post("Handler/InvoiceProvisinalStatusHandler.ashx", { ii: "<%=this.curBusinessInvoice.BusinessInvoiceId%>", oi: operateId },
                    function (result) {
                        alert(result);
