<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceReplaceFinalProvisionalList.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceReplaceFinalProvisionalList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {            
            ...
            var url = "Handler/InvoiceProvisionalListHandler.ashx?s=" + statusEnum.已生效;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/InvoiceProvisionalListHandler.ashx?s=" + statusEnum.已生效 + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
