<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalCreate.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceProvisionalCreate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCreate").click(function () {
                ...
                $.post("Handler/InvoiceProvisionalCreateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceBusiness: JSON.stringify(invoiceBusiness),Details: JSON.stringify(rows) },
                    function (result) {
