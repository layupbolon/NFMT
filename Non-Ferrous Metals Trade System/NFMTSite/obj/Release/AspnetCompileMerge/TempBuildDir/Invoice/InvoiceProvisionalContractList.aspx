<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalContractList.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceProvisionalContractList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var corpSource = { datatype: "json", url: corpUrl, async: false, searchMode: "containsignorecase" };
            ...
            var url = "Handler/InvoiceProvisionalContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                if (item.TradeDirection == "<%=(int)NFMT.Contract.TradeDirectionEnum.Buy%>") {
                    cellHtml += "<a target=\"_self\" href=\"InvoiceProvisionalCreate.aspx?d=" + "<%=(int)NFMT.Invoice.InvoiceDirectionEnum.收取%>" + "&id=" + value + "\">临票收取";
                }
                else if (item.TradeDirection == "<%=(int)NFMT.Contract.TradeDirectionEnum.Sell%>") {
                    cellHtml += "<a target=\"_self\" href=\"InvoiceProvisionalCreate.aspx?d=" + "<%=(int)NFMT.Invoice.InvoiceDirectionEnum.开具%>" + "&id=" + value + "\">临票开具";
                }
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/InvoiceProvisionalContractListHandler.ashx?sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
