<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancingPledgeApplyUpdate.aspx.cs" Inherits="NFMTSite.Financing.FinancingPledgeApplyUpdate" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function PledgeApplyUpdate() {
                ...
                $.post("Handler/FinancingPledgeApplyUpdateHandler.ashx", { pledgeApply: JSON.stringify(pledgeApply), rows: JSON.stringify(rows) },
                    function (result) {
            ...
            $("#btnSave").click(function () { PledgeApplyUpdate(); });
            ...
            $("#popupWindow").jqxValidator({
                rules:
                    [
                        ...
                        {
                            input: "#nbNetAmount", message: "净重必须大于0", action: "keyup,blur", rule: function (input, commit) {
                                return $("#nbNetAmount").jqxNumberInput("val") > 0;
                            }
                        },
                        { input: "#txbRefNo", message: "请选择业务单号", action: "keyup,blur", rule: "required" },
