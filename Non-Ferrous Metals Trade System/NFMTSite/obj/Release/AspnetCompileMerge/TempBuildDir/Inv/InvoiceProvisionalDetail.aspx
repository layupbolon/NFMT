<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalDetail.aspx.cs" Inherits="NFMTSite.Inv.InvoiceProvisionalDetail" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnInvalid").on("click", function () {
                ...
                $.post("../Invoice/Handler/InvoiceProvisinalStatusHandler.ashx", { ii: "<%=this.curBusinessInvoice.BusinessInvoiceId%>", oi: operateId },
                    function (result) {
                        alert(result);
