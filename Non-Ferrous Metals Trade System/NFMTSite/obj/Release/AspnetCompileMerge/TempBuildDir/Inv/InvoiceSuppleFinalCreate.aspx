<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSuppleFinalCreate.aspx.cs" Inherits="NFMTSite.Inv.InvoiceSuppleFinalCreate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCreate").click(function () {
                ...
                $.post("../Invoice/Handler/InvoiceSuppleFinalCreateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceBusiness: JSON.stringify(invoiceBusiness),Details: JSON.stringify(rows) },
                    function (result) {
