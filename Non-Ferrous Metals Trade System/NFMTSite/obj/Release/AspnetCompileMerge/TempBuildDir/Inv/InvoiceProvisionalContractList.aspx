<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalContractList.aspx.cs" Inherits="NFMTSite.Inv.InvoiceProvisionalContractList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "../Invoice/Handler/InvoiceProvisionalContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "../Invoice/Handler/InvoiceProvisionalContractListHandler.ashx?sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
