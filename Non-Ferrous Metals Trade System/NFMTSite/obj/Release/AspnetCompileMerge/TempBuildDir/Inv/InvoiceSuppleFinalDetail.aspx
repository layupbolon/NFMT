<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSuppleFinalDetail.aspx.cs" Inherits="NFMTSite.Inv.InvoiceSuppleFinalDetail" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var auditUrl = "../WorkFlow/Handler/AuditProgressListHandler.ashx?b=" + "<%=this.curInvoice.DataBaseName%>" + "&t=" + "<%=this.curInvoice.TableName%>" + "&id=" + "<%=this.curSuppleInvoice.BusinessInvoiceId%>";
        ...
        $(document).ready(function () {
            ...
            $("#jqxStockGrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "回执磅差", datafield: "QtyMiss" },
                  { text: "补零金额", datafield: "Bala" }
                ]
            });            
            ...
            $("#btnInvalid").on("click", function () {
                ...
                $.post("../Invoice/Handler/InvoiceSuppleFinalStatusHandler.ashx", { ii: "<%=this.curSuppleInvoice.BusinessInvoiceId%>", oi: operateId },
                    function (result) {
                        alert(result);
