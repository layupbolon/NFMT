<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractOutCreate.aspx.cs" Inherits="NFMTSite.Contract.ContractOutCreate" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#selTradeDirection").val(<%=(int)NFMT.Contract.TradeDirectionEnum.销售%>);
        ...
        $("#selAsset").val(<%=this.curAsset.AssetId%>);
        ...
        function ContractCreate(isAudit) {
            ...
            var contract = {
                ...
                PriceMode: priceMode,
                Memo: $("#txbMemo").val(),
                CreateFrom: "<%=(int)NFMT.Common.CreateFromEnum.销售合约库存创建%>",
            ...
            $.post("Handler/ContractOutCreateHandler.ashx", { Contract: JSON.stringify(contract), ContractDetail: JSON.stringify(contractDetail), ContractPrice: JSON.stringify(contractPrice), OutCorps: outCorps, InCorps: inCorps, Depts: depts, IsSubmitAudit: isAudit, sub: JSON.stringify(subContract), checkedClause: JSON.stringify(eval(checkedClause)), stocks: JSON.stringify(rows), ContractTypes: contractTypes },
                function (result) {
                    ...
                    if (obj.ResultStatus.toString() == "0") {
                        ...
                        if (isAudit) {
                            AutoSubmitAudit(MasterEnum.销售合约审核, JSON.stringify(obj.ReturnValue));
                        }
                    }
                    alert(obj.Message);
                    if (obj.ResultStatus.toString() == "0") {
