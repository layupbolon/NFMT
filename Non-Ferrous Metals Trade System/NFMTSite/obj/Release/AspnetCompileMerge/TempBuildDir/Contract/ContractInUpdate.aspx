<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractInUpdate.aspx.cs" Inherits="NFMTSite.Contract.ContractInUpdate" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#selContractLimit").jqxComboBox({ source: limitDataAdapter, displayMember: "DetailName", valueMember: "StyleDetailId", width: 100, height: 25, autoDropDownHeight: true });
