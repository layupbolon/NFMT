<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepoApplyUpdate.aspx.cs" Inherits="NFMTSite.WareHouse.RepoApplyUpdate" %>
        ...
        $(document).ready(function () {
            ...
            for (i = 0; i < splitItem.length; i++) {
                if (splitItem[i].length > 0) {
                    stockIds.push(parseInt(splitItem[i]));
                }
            }

            var repoApplyId = $("#hidrepoApplyId").val();
            /////////////////////////回购申请信息/////////////////////////
            ...
            $("#jqxApplyGrid").jqxGrid(
            {
                ...
                for (i = 0; i < deletes.length; i++) {
                    ...
                    $(btnDelete).click({ value: val }, function (event) {
                        var rowId = parseInt(event.data.value);
                        ...
                        source.url = "Handler/CanRepoApplyListHandler.ashx?sids=" + sids + "&repoApplyId=" + repoApplyId
            ...
            //var url = "Handler/CanRepurchaseListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
                ...
                url: "Handler/CanRepoApplyListHandler.ashx?sids=" + sids + "&repoApplyId=" + repoApplyId
            };
            ...
            $("#ddlApplyCorpId").jqxComboBox({ source: ownCorpDataAdapter, displayMember: "CorpName", valueMember: "CorpId", searchMode: "containsignorecase" });
            ...
            $("#ddlApplyDeptId").jqxComboBox({ source: ddlApplyDeptIddataAdapter, displayMember: "DeptName", valueMember: "DeptId", width: 180, height: 25 });
            var deptId = $("#hidDeptId").val();
            $("#ddlApplyDeptId").jqxComboBox("val", deptId);
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/RepoApplyUpdateHandler.ashx", {
                    repo: JSON.stringify(rows),
                    apply: JSON.stringify(apply),
                    rid:"<%=this.repoApplyId%>"
                },
                    function (result) {
...
<body>
    ...
    <div id="jqxApplyExpander" style="float: left; margin: 0px 5px 5px 5px;">
        ...
        <div style="height: 500px;">
            ...
            <input type="hidden" id="hidrepoApplyId" runat="server" />
