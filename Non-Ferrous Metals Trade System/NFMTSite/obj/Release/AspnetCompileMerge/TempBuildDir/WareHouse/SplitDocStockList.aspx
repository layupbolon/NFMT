<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SplitDocStockList.aspx.cs" Inherits="NFMTSite.WareHouse.SplitDocStockList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#selOwnCorp").jqxComboBox({ source: corpDataAdapter, displayMember: "CorpName", valueMember: "CorpId", width: 180, height: 25 });

            var url = "Handler/SplitDocStockListHandler.ashx?s=220";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return "<div style=\"overflow: hidden; text-overflow: ellipsis; padding-bottom: 2px; text-align: center; margin-right: 2px; margin-left: 4px; margin-top: 4px;\"><a target=\"_self\" href=\"SplitDocCreate.aspx?id=" + value + "\">拆单</a></div>";;
            }
            $("#jqxgrid").jqxGrid(
            {
                width: "98%",
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/SplitDocStockListHandler.ashx?s=220&sn=" + stockName + "&ci=" + corpId + "&sdb=" + fromDate + "&sde=" + toDate;
