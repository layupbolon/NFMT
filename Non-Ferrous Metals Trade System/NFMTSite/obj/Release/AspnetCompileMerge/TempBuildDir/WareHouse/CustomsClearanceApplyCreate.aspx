<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomsClearanceApplyCreate.aspx.cs" Inherits="NFMTSite.WareHouse.CustomsClearanceApplyCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/CustomApplyStockListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/CustomApplyCreate.ashx", {
...
<body>
    ...
    <NFMT:Attach runat="server" ID="attach1" AttachStyle="Create" AttachType="CustomApplyAttach" />
