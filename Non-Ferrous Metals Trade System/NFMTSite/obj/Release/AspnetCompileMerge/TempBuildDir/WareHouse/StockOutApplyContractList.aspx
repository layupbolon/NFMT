<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockOutApplyContractList.aspx.cs" Inherits="NFMTSite.WareHouse.StockOutApplyContractList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/StockOutApplyContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return "<div style=\"overflow: hidden; text-overflow: ellipsis; padding-bottom: 2px; text-align: center; margin-right: 2px; margin-left: 4px; margin-top: 4px;\"><a target=\"_self\" href=\"StockOutApplyCreate.aspx?id=" + value + "\">配货</a></div>";
            }
            $("#jqxgrid").jqxGrid(
            {
                width: "98%",
                ...
                columns: [
                  ...
                  { text: "子合约配款", datafield: "AllotBala" },
                  { text: "已配货量", datafield: "AllotWeigth" },
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/StockOutApplyContractListHandler.ashx?sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
