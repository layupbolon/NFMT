<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PricingCreate.aspx.cs" Inherits="NFMTSite.DoPrice.PricingCreate" %>
...
<body>
    ...
    <div id="jqxCanDoPriceStockExpander" style="float: left; margin: 0px 5px 5px 5px;">
        <div>
            可点价库存信息<input type="hidden" id="hidDetailsId" runat="server" />
        </div>
        <div>
