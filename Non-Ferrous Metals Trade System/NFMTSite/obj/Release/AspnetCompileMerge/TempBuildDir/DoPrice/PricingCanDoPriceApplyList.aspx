<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PricingCanDoPriceApplyList.aspx.cs" Inherits="NFMTSite.DoPrice.PricingCanDoPriceApplyList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //绑定Grid
            var url = "Handler/PricingCanDoPriceListHandler.ashx?s=" + statusEnum.已生效;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                if (item.DetailRow > 0) {
                    cellHtml += "<a target=\"_self\" href=\"PricingCreate.aspx?id=" + value + "\">点价</a>";
                }
                else {
                    cellHtml += "<a target=\"_self\" href=\"PricingContractCreate.aspx?id=" + value + "\">点价</a>";
                }
                cellHtml += "</div>";
                return cellHtml;
            }
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/PricingCanDoPriceListHandler.ashx?s=" + statusEnum.已生效 + "&a=" + applyDept + "&f=" + fromDate + "&t=" + toDate;
