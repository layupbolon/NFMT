<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StopLossApplyCreate.aspx.cs" Inherits="NFMTSite.DoPrice.StopLossApplyCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //点价均价
            $("#txbAvgPrice").jqxNumberInput({ height: 25, min: 0, decimalDigits: 4, width: 160, spinButtons: true, symbol: "<%=this.currency.CurrencyName%>", symbolPosition: "right", disabled: true });
            ...
            var selectSource =
            {
                ...
                url: "Handler/StopLossApplyCreateStockListHandler.ashx?pricingId=" + "<%=this.pricing.PricingId%>"
            };
            ...
            //止损申请公司
            var ownCorpUrl = "../User/Handler/AuthSelfCorpHandler.ashx?SubId=" + "<%=this.pricingApply.SubContractId%>";
            var ownCorpSource = { datatype: "json", url: ownCorpUrl, async: false };
            var ownCorpDataAdapter = new $.jqx.dataAdapter(ownCorpSource);
            ...
            //止损申请部门, autoDropDownHeight: true
            ...
            $("#ddlStopLossApplyDept").jqxComboBox("val", "<%=this.deptId%>");
            ...
            //止损价格
            $("#nbStopLossPrice").jqxNumberInput({ height: 25, min: 0, decimalDigits: 4, width: 160, spinButtons: true, symbol: "<%=this.currency.CurrencyName%>", symbolPosition: "right" });
            ...
            $("#jqxStopLossExpander").jqxValidator({
                rules:
                    [
                        ...
                        {
                            input: "#nbStopLossWeight", message: "止损重量必须大于0且不大于<%=this.pricing.PricingWeight-this.alreadyStopLossWeight%>"+"<%=this.measureUnit.MUName%>", action: "keyup,blur", rule: function (input, commit) {
                                return $("#nbStopLossWeight").jqxNumberInput("val") > 0 && $("#nbStopLossWeight").jqxNumberInput("val") <= "<%=this.pricing.PricingWeight-this.alreadyStopLossWeight%>";
                            }
                        }
                    ]
            });
            ...
            $("#btnCreate").click(function () {
                ...
                $.post("Handler/StopLossApplyCreateHandler.ashx", {
...
<body>
        ...
        <div class="InfoExpander">
            <ul>
                ...
                <li>
                 ...
                 <li>
                    <strong>已止损重量：</strong>
                    <span id="spnAlreadyStopLossWeight" style="float:left" runat ="server"/>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div style="width: 80%; text-align: center;">
        <input type="button" id="btnCreate" value="新增止损申请" style="width: 125px; height: 25px;" />&nbsp;&nbsp;&nbsp;&nbsp;
        <a target="_self" runat="server" href="StopLossApplyPricingList.aspx" id="btnCancel">取消</a>&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
