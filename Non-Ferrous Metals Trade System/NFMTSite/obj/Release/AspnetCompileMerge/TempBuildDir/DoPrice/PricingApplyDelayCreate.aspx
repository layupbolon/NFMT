<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PricingApplyDelayCreate.aspx.cs" Inherits="NFMTSite.DoPrice.PricingApplyDelayCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var muName = "<%=NFMT.Data.BasicDataProvider.MeasureUnits.SingleOrDefault(a => a.MUId == mUId).MUName%>";
            ...
            //延期重量
            $("#nbDelayAmount").jqxNumberInput({ height: 25, min: 0, decimalDigits: 4, width: 140, spinButtons: true, symbol: muName, symbolPosition: "right" });
            ...
            $("#jqxDelayExpander").jqxValidator({
                rules:
                    [
                        {
                            input: "#nbDelayAmount", message: "延期重量必须大于0且小于" + "<%=this.canDelayWeight%>" + muName, action: "keyup,blur", rule: function (input, commit) {
                                return $("#nbDelayAmount").jqxNumberInput("val") > 0 && $("#nbDelayAmount").jqxNumberInput("val") < "<%=this.canDelayWeight%>";
                            }
                        },
                        {
            ...
            $("#btnCreate").click(function () {
                ...
                $.post("Handler/PricingApplyDelayCreateHandler.ashx", {
...
<body>
    ...
    <div style="width: 80%; text-align: center;">
        ...
        <a target="_self" runat="server" href="PricingApplyDelayPricingApplyList.aspx" id="btnCancel">取消</a>&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
</body>
</html>
