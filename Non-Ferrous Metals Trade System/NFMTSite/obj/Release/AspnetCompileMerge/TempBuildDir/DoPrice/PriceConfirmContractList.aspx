<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceConfirmContractList.aspx.cs" Inherits="NFMTSite.DoPrice.PriceConfirmContractList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/PriceConfirmContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"PriceConfirmCreate.aspx?subId=" + value + "\">价格确认单新增</a>"
                cellHtml += "</a>";
                cellHtml += "</div>";
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "操作", datafield: "SubId", cellsrenderer: cellsrenderer, width: 120 }
                ]
            });

            $("#btnSearch").click(function () {
                var subNo = $("#txbContractCode").val();
                source.url = "Handler/PriceConfirmContractListHandler.ashx?sn=" + subNo;
