<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivableCorpList.aspx.cs" Inherits="NFMTSite.Funds.ReceivableCorpList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/ReceivableCorpListHandler.ashx?e=" + empId + "&s=" + status;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"ReceivableCorpDetail.aspx?id=" + value + "\">明细</a>";
                if (item.AllotStatus > statusEnum.已作废 && item.AllotStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"ReceivableCorpUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#btnSearch").click(function () {
                var empId = $("#ddlEmpId").val();
                var status = $("#ddlAllotStatus").val();
                source.url = "Handler/ReceivableCorpListHandler.ashx?e=" + empId + "&s=" + status;
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="ReceivableCorpReadyCorpList.aspx" id="btnAdd">收款分配</a>
                </li>
            </ul>
        </div>
    </div>
