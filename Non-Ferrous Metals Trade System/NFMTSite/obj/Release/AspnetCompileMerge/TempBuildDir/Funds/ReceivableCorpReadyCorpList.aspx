<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivableCorpReadyCorpList.aspx.cs" Inherits="NFMTSite.Funds.ReceivableCorpReadyCorpList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            url = "Handler/ReceivableCorpReadyCorpListHander.ashx?Code=" + CorpCode + "&Name=" + CorpName + "&s=" + CorpStatus + "&blocId=" + BlocId;
            var formatedData = "";
            var totalrecords = 0;
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return "<div style=\"overflow: hidden; text-overflow: ellipsis; padding-bottom: 2px; text-align: center; margin-right: 2px; margin-left: 4px; margin-top: 4px;\">"
                   + "<a target=\"_self\" href=\"ReceivableCorpCreate.aspx?id=" + value + "\">分配</a>"
                   + "</div>";
            }
            ...
            $("#btnSearch").click(function () {
                ...
                var CorpName = $("#CorpName").val();
                var CorpStatus = $("#CorpStatus").val();
                source.url = "Handler/ReceivableCorpReadyCorpListHander.ashx?Code=" + CorpCode + "&Name=" + CorpName + "&s=" + CorpStatus + "&blocId=" + BlocId;
