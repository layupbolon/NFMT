<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashInAllotCorpList.aspx.cs" Inherits="NFMTSite.Funds.CashInAllotCorpList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //绑定Grid
            var url = "Handler/CashInAllotCorpListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/CashInAllotCorpListHandler.ashx?e=" + empId + "&s=" + status;
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="CashInAllotReadyCorpList.aspx" id="btnAdd">收款分配</a>
                </li>
            </ul>
        </div>
    </div>
