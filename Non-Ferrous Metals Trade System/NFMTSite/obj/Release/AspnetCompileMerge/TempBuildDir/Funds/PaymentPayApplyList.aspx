<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentPayApplyList.aspx.cs" Inherits="NFMTSite.Funds.PaymentPayApplyList" %>
        ...
        $(document).ready(function () {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                if (item.PayApplySource == FundsEnum.ContractPayApply) {
                    cellHtml += "<a target=\"_self\" href=\"PaymentContractCreate.aspx?id=" + value + "\">付款</a>";
                }
                else if (item.PayApplySource == FundsEnum.StockPayApply) {
                    cellHtml += "<a target=\"_self\" href=\"PaymentStockCreate.aspx?id=" + value + "\">付款</a>";
                }
                else if (item.PayApplySource == FundsEnum.InvoicePayApply) {
                    cellHtml += "<a target=\"_self\" href=\"PaymentInvoiceCreate.aspx?id=" + value + "\">付款</a>";
                }
