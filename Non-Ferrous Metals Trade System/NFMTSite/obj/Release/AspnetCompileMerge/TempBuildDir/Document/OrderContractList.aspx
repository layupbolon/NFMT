<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderContractList.aspx.cs" Inherits="NFMTSite.Document.OrderContractList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/OrderContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"OrderCreate.aspx?id=" + value + "\">制单指令</a>";
                cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                cellHtml += "<a target=\"_self\" href=\"OrderNoStockCreate.aspx?id=" + value + "\">无配货制单指令</a>";
                cellHtml += "</div>";
                return cellHtml;
            }
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "操作", datafield: "SubId", cellsrenderer: cellsrenderer, width: 200 }
                ]
            });
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/OrderContractListHandler.ashx?sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
