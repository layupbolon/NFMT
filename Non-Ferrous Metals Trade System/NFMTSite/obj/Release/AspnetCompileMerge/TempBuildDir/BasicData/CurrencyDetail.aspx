<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrencyDetail.aspx.cs" Inherits="NFMTSite.BasicData.CurrencyDetail" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnFreeze").on("click", function () {
                ...
                $.post("Handler/CurrencyStatusHandler.ashx", { id: id, oi: operateId },
                    function (result) {
                        alert(result);
                    }
                );
        ...
        <div class="DataExpander">
            <ul>
                <li>
                    ...
                    <span id="txbCurrencyName" runat="server" />
                    <input type="hidden" runat="server" id="hidId" />
                </li>
                <li>
                    <h4><span>币种缩写：</span></h4>
                    <span id="txbCurencyShort" runat="server" /></li>
                <li>
                    <h4><span>币种全称：</span></h4>
                    <span id="txbCurrencyFullName" runat="server"></span></li>
                <li>
                    <h4><span>币种状态：</span></h4>
                    <span id="txbCurrencyStatus" runat="server"></span></li>
