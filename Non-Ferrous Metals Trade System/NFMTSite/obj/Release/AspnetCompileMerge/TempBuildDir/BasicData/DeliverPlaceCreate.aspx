<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliverPlaceCreate.aspx.cs" Inherits="NFMTSite.BasicData.DeliverPlaceCreate" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/DeliverPlaceCreateHandler.ashx", {
...
<body>
    ...
    <div id="jqxExpander" style="float: left; margin: 0px 5px 5px 5px;">
        <div>
            交货地新增<input type="hidden" id="hidBDStyleId" runat="server"/>
        </div>
        <div id="layOutDiv">
            <ul>
                <li>
