<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FuturesCodeDetail.aspx.cs" Inherits="NFMTSite.BasicData.FuturesCodeDetail" %>
    ...
    <div id="jqxExpander" style="float: left; margin: 0px 5px 5px 5px;">
        ...
        <div class="DataExpander">
            <ul>
                ...
                <li>
                    <h4><span>币种：</span></h4>
                    <span id="spnCurrency" runat="server"></span></li>
                <li>
