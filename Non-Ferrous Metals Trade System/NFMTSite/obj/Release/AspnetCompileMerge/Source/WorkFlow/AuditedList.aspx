<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditedList.aspx.cs" Inherits="NFMTSite.WorkFlow.AuditedList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/AuditedListHandler.ashx?k=" + taskName + "&uid=" + empId;
            var formatedData = "";
            var totalrecords = 0;
            ...
            var source = {
                ...
                formatdata: function (data) {
                    ...
                    data.sortdatafield = data.sortdatafield || "t.TaskId";
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return "&nbsp;&nbsp;&nbsp;<a target=\"_self\" href=\"AuditedDetail.aspx?id=" + value + "\">明细</a> ";
            }
            ...
            $("#jqxGrid").jqxGrid(
            {
                ...
                columns: [
                      ...
                      { text: "任务状态", datafield: "StatusName" },
                      { text: "操作", datafield: "TaskId", cellsrenderer: cellsrenderer, width: 100, enabletooltips: false }
                ]
            });
            ...
            function LoadData() {
                var taskName = $("#txbTaskName").val();
                source.url = "Handler/AuditedListHandler.ashx?k=" + taskName + "&uid=" + empId;
