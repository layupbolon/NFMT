<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderReplaceList.aspx.cs" Inherits="NFMTSite.Document.OrderReplaceList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/OrderReplaceListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                if (item.OrderStatus > statusEnum.已关闭 && item.OrderStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"OrderReplaceUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/OrderReplaceListHandler.ashx?cn=" + contractNo + "&ci=" + corpId + "&db=" + fromDate + "&de=" + toDate + "&s=" + status;
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="OrderCommercialList.aspx" id="btnAddOrder">新建替临制单指令</a>
                </li>
            </ul>
        </div>
    </div>
