<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentNoStockCreate.aspx.cs" Inherits="NFMTSite.Document.DocumentNoStockCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCreateDocument").jqxInput();
            $("#btnCreateAuditDocument").jqxInput();           
        ...
        function CreateDocument(isAudit) {

            if (docStocks.length == 0) { alert("未选中任何库存"); return; }
            if (!confirm("确认新增制单?")) { return; }
            ...
            $.post("Handler/DocumentCreateHandler.ashx", { document: JSON.stringify(Document), docStocks: JSON.stringify(docStocks), IsSubmitAudit: isAudit },
                   function (result) {
...
<body>
    ...
    <div id="buttons" style="width: 80%; text-align: center; float: left;">
        <input type="button" value="新增制单并提交审核" id="btnCreateAuditDocument" onclick="CreateDocument(true);" style="width: 180px; height: 25px;" />
        <input type="button" value="新增制单" id="btnCreateDocument" onclick="CreateDocument(false);" style="width: 120px; height: 25px;" />
    </div>
