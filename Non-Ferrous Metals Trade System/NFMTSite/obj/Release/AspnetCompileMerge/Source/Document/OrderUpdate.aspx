<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderUpdate.aspx.cs" Inherits="NFMTSite.Document.OrderUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //可售库存
            var sellUrl = "Handler/OrderStockListHandler.ashx?cid=" + "<%= this.curOrder.ContractId%>" +"&orderId="+"<%=this.curOrder.OrderId%>";
            sellSource =
            {
                datatype: "json",
                sort: function () {
        ...
        function bntCreateOnClick(row) {
            ...
            if (selectedStocks.length == 1) {
                ...
                $("#txbGrossAmount").jqxNumberInput({ disabled: true });
                $("#txbNetAmount").jqxNumberInput({ disabled: true });
                $("#txbBundles").jqxNumberInput({ disabled: true });
                $("#txbInvoiceBala").jqxNumberInput({ disabled: true });
            }
        ...
        function FlushGrid() {
            ...
            sellSource.url = "Handler/OrderStockListHandler.ashx?sids=" + sids + "&dids=" + dids + "&cid=" + "<%= this.curOrder.ContractId%>" + "&refNo=" + refNo + "&ownCorpId=" + ownCorpId;
