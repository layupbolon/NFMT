<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderReadyList.aspx.cs" Inherits="NFMTSite.Document.OrderReadyList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/OrderListHandler.ashx?re=true&s=" + statusEnum.已生效;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                if (item.OrderType == orderTypeEnum.无配货临票制单指令 || item.OrderType == orderTypeEnum.无配货终票制单指令) {
                    cellHtml += "<a target=\"_self\" href=\"DocumentNoStockCreate.aspx?id=" + value + "\">制单</a>";
                }
                else if(item.OrderType == orderTypeEnum.临票制单指令 || item.OrderType == orderTypeEnum.终票制单指令) {
                    cellHtml += "<a target=\"_self\" href=\"DocumentCreate.aspx?id=" + value + "\">制单</a>";
                }
