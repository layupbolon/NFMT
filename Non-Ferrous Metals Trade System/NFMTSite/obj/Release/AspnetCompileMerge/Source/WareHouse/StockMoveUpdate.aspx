<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockMoveUpdate.aspx.cs" Inherits="NFMTSite.WareHouse.StockMoveUpdate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //按钮
            $("#btnUpdate").jqxButton({ height: 25, width: 85 });
            ...
            $("#btnUpdate").on("click", function () {
                $.post("Handler/StockMoveUpdateHandler.ashx", { id: $("#hidid").val(), memo: $("#txbMoveMemo").val() },
                    function (result) {
        ...
        <div id="layOutDiv">
            <ul>
                <li><span style="text-align: right; width: 15%;">移库备注：</span>
                    <input type="text" id="txbMoveMemo" runat="server" /></li>
                <li>
                    <span style="text-align: right; width: 15%;">&nbsp;</span>
                    <span>
                        <input type="button" id="btnUpdate" value="提交修改" runat="server" /></span>
