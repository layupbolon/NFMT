<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockMoveApplyCreate.aspx.cs" Inherits="NFMTSite.WareHouse.StockMoveApplyCreate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/CanStockMoveListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/StockMoveApplyCreateHandler.ashx", {
