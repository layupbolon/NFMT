<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockInConUpdate.aspx.cs" Inherits="NFMTSite.WareHouse.StockInConUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //入账公司
            var ddlCorpIdurl = "../User/Handler/AuthSelfCorpHandler.ashx?ContractId=" + "<%=this.curContractId%>";
            ...
            $("#btnUpdate").on("click", function () {
                ...
                $.post("Handler/StockInUpdateHandler.ashx",{StockIn: JSON.stringify(stockInModel)},
                    function (result) {
...
<body>
    ...
    <input type="hidden" id="hidDivHidden" runat="server" />
    ...
    <div style="width: 80%; text-align: center;">
        ...
        <a target="_self" href="StockInList.aspx" id="btnCancel">取消</a>
    </div>
</body>
