<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomsClearanceCreate.aspx.cs" Inherits="NFMTSite.WareHouse.CustomsClearanceCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/CustomClearanceStockListHandler.ashx?c="+"<%=this.customsApplyId%>";
            var formatedData = "";
            var totalrecords = 0;
            var Infosource =
            {
            ...
            $("#jqxCustomGrid").jqxGrid(
            {
                ...
                for (i = 0; i < deletes.length; i++) {
                    ...
                    $(btnDelete).click({ value: val }, function (event) {
                        ...
                        //刷新列表
                        Infosource.url = "Handler/CustomClearanceStockListHandler.ashx?c=" + "<%=this.customsApplyId%>" + "&sids=" + sidsUp;
                        $("#jqxCustomGrid").jqxGrid("updatebounddata", "rows");
                        source.url = "Handler/CustomClearanceStockListHandler.ashx?c=" + "<%=this.customsApplyId%>" + "&sids=" + sidsDown;
            ...
            var url = "Handler/CustomClearanceStockListHandler.ashx?c=" + "<%=this.customsApplyId%>" + "&sids=" + sidsDown;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnAdd").on("click", function () {
                ...
                var customsClearance = {
                    CustomsApplyId: "<%=this.customsApplyId%>",
                    //Customser
                ...
                $.post("Handler/CustomCreateHandler.ashx", {
...
<body>
    ...
    <NFMT:Attach runat="server" ID="attach1" AttachStyle="Create" AttachType="CustomAttach" />

    <div style="width: 80%; text-align: center;">
        <input type="button" id="btnAdd" value="提交" />&nbsp;&nbsp;&nbsp;&nbsp;
        <a target="_self" runat="server" href="CustomCanApplyList.aspx" id="btnCancel">取消</a>
    </div>
</body>
</html>
