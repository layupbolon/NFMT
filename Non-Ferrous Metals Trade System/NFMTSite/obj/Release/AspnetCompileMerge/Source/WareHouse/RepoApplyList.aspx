<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepoApplyList.aspx.cs" Inherits="NFMTSite.WareHouse.RepoApplyList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlApplyPerson").jqxComboBox({ source: ddlPaperHolderdataAdapter, displayMember: "Name", valueMember: "EmpId", width: 120, height: 25});
            ...
            //绑定Grid
            var url = "Handler/RepoApplyListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"RepoApplyDetail.aspx?id=" + value + "\">明细</a>"

                if (item.ApplyStatus > statusEnum.已关闭 && item.ApplyStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"RepoApplyUpdate.aspx?id=" + value + "\">修改</a>"
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#btnSearch").click(function () {
                ...
                var status = $("#ddlRepoApplyStatus").val();
                var fromDate = $("#txbFromCreateDate").val();
                var toDate = $("#txbToCreateDate").val();
                source.url = "Handler/RepoApplyListHandler.ashx?a=" + applyPerson + "&s=" + status + "&f=" + fromDate + "&t=" + toDate;
    ...
    <div id="jqxExpander" style="float: left; margin: 0px 5px 5px 5px; padding-bottom: 10px;">
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    <span style="float: left;">回购申请状态：</span>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="RepoApplyCreate.aspx" id="btnAdd">新增回购申请</a>
                </li>
            </ul>
        </div>
    </div>
