<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PledgeApplyUpdate.aspx.cs" Inherits="NFMTSite.WareHouse.PledgeApplyUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var pledgeApplyId = $("#hidpledgeApplyId").val();

            /////////////////////////质押申请信息/////////////////////////

            //var url = "Handler/PledgeApplyInfoHandler.ashx?sids=" + sids + "&applyId=" + pledgeApplyId;
            //var formatedData = "";
            //var totalrecords = 0;
            var Infosource =
            {
                ...
                columns: [
                  ...
                  { text: "币种", datafield: "CurrencyName" },
                  {
                      text: "操作", datafield: "Edit", columntype: "button", width: 90, cellsrenderer: function () {
                          ...
                          //刷新列表
                          Infosource.localdata = details;
                          $("#jqxApplyGrid").jqxGrid("updatebounddata", "rows");    
                          source.url = "Handler/CanPledgeHandler.ashx?sids=" + sids + "&pid=" + "<%=this.pledgeApply.PledgeApplyId%>";
            ...
            details = $("#jqxApplyGrid").jqxGrid("getrows");
            ...
            var url = "Handler/CanPledgeHandler.ashx?sids=" + sids + "&pid=" + "<%=this.pledgeApply.PledgeApplyId%>";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/PledgeApplyUpdateHandler.ashx", {
...
<body>
    ...
    <div id="jqxApplyExpander" style="float: left; margin: 0px 5px 5px 5px;">
        ...
        <div style="height: 500px;">
            ...
            <input type="hidden" id="hidpledgeApplyId" runat="server" />
