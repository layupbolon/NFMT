<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashInAllotContractUpdate.aspx.cs" Inherits="NFMTSite.Funds.CashInAllotContractUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //        return formatedData;
            //    },
            //    url: "Handler/CashInContractOtherAllotListHandler.ashx?subId="
            //};
            ...
            $("#jqxCashInAllotGrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  {
                      text: "分配公司", datafield: "AllotCorpId", displayfield: "AllotCorp", columntype: "combobox",
            ...
            //初始化数据
            corpDetails = $("#jqxCorpSelectGrid").jqxGrid("getrows");

            var refIds = "";
            for (i = 0; i < corpDetails.length; i++) {
                if (i != 0) { refIds += ","; }
                refIds += corpDetails[i].CorpRefId;
            }
            ...
            corpAllotSource =
            {
                ...
                url: "Handler/CashInCorpLastListHandler.ashx?currencyId=" + "<%=this.curSub.SettleCurrency%>" +"&corpIds="+"<%=this.curOutCorpIds%>"+"&cropRefIds="+refIds
            };
            ...
            $("#btnUpdate").click(function () {
                if (cashInDetails.length > 0) {
                    ...
                    $.post("Handler/CashInContractDirectUpdateHandler.ashx", {
                       ...
                       function (result) {
                           alert(result);
                           document.location.href = "CashInAllotContractList.aspx";
                       }
                   );
                }
                    ...
                    $.post("Handler/CashInContractUpdateHandler.ashx", {
                        Details: JSON.stringify(rows),
                        SubId: "<%=this.curSub.SubId%>"
                    },
                       function (result) {
    ...
    var currencyId=<%=this.curSub.SettleCurrency%>;
        ...
        function flushCorpGrid() {
            ...
            //contractRefIds
            var contractRefIds ="";
            for(i =0 ;i<corpExcs.length;i++){
                if (i != 0) { contractRefIds += ","; }
                contractRefIds += corpExcs[i].DetailId;
            }
            
            corpAllotSource.url = "Handler/CashInCorpLastListHandler.ashx?currencyId=" + "<%=this.curSub.SettleCurrency%>" +"&corpIds="+"<%=this.curOutCorpIds%>"+"&cropRefIds="+cropRefIds+"&contractRefIds="+contractRefIds;
