<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentInvoiceCreate.aspx.cs" Inherits="NFMTSite.Funds.PaymentInvoiceCreate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCreate").click(function () {
                ...
                $.post("Handler/PaymentInvoiceCreateHandler.ashx", { Payment: JSON.stringify(payment), Details: JSON.stringify(rows),PayApplyId:"<%= this.curPayApply.PayApplyId%>" },
                    function (result) {
