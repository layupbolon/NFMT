<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashInAllotMainList.aspx.cs" Inherits="NFMTSite.Funds.CashInAllotMainList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlEmpId").jqxComboBox({ source: ddlPledgedataAdapter, displayMember: "Name", valueMember: "EmpId", width: 180, height: 25 });
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"CashInAllotMainDetail.aspx?id=" + value + "\">明细</a>";
                if (item.AllotStatus > statusEnum.已关闭 && item.AllotStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"CashInAllotMainUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="CashInAllotMainReadyCashInList.aspx" id="btnAdd">收款分配</a>
                </li>
            </ul>
        </div>
    </div>
