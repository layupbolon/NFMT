<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractReceivableDetail.aspx.cs" Inherits="NFMTSite.Funds.ContractReceivableDetail" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var source =
            {
                ...
                url: "Handler/ContractReceivableDetailHandler.ashx?id=" + $("#hidid").val()
            };
            ...
            $("#btnInvalid").on("click", function () {
                ...
                $.post("Handler/ContractReceivableInvalidHandler.ashx", { id: $("#hidid").val() },
                    function (result) {
                        alert(result);
                        window.document.location = "ContractReceivableList.aspx";
                    }
                );
            });
            ...
            $("#btnComplete").on("click", function () {
                ...
                $.post("Handler/ContractReceivableCompleteHandler.ashx", { id: $("#hidid").val() },
                    function (result) {
                        alert(result);
                        window.document.location = "ContractReceivableList.aspx";
                    }
    ...
    <div id="jqxExpander" style="float: left; margin: 10px 5px 5px 5px;">
        ...
        <div class="InfoExpander">
            <ul>
                ...
                <li>
                    <strong>备注：</strong>
                    <span id="spanAllotDesc" style="float: left;" runat="server"></span>
                </li>
                <li>
                    <strong>分配人：</strong>
                ...
                <li>
                    <strong>分配时间：</strong>
                    <span id="spanAllotTime" style="float: left;" runat="server"></span>
                </li>
            </ul>
        </div>
    </div>
