<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentStockUpdate.aspx.cs" Inherits="NFMTSite.Funds.PaymentStockUpdate" %>
        ...
        $(document).ready(function () {
            ...
            $("#jqxPayApplyExpander").jqxValidator({
                rules:
                    [
                        {
                            input: "#selPayCorp", message: "付款公司必选", action: "change", rule: function (input, commit) {
                                return $("#selPayCorp").jqxComboBox("val") > 0;
                            }
                        },
                        {
                            input: "#selPayBank", message: "付款银行必选", action: "change", rule: function (input, commit) {
                                return $("#selPayBank").jqxComboBox("val") > 0;
                            }
                        },
                        {
                            input: "#selPayAccount", message: "付款账户", action: "change", rule: function (input, commit) {
                                return $("#selPayAccount").jqxComboBox("val") > 0;
                            }
                        },                        
                        {
                            input: "#txbpayBala", message: "付款金额不能小于0并且不能大于可付总额", action: "valueChanged", rule: function (input, commit) {
                                var bala = $("#txbpayBala").jqxNumberInput("val");                              
                                return bala > 0 && bala <= sumLastBala;
                            }
                        },
                        {
                            input: "#selRecCorp", message: "收款公司必选", action: "change", rule: function (input, commit) {
                                return $("#selRecCorp").jqxComboBox("val") > 0;
                            }
                        },
                        {
                            input: "#selRecBank", message: "收款开户行必选", action: "change", rule: function (input, commit) {
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("Handler/PaymentStockUpdateHandler.ashx", { Payment: JSON.stringify(payment), Detail: JSON.stringify(rows) },
                    function (result) {
