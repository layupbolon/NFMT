<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorpFundsAllotReadyContractList.aspx.cs" Inherits="NFMTSite.Funds.CorpFundsAllotReadyContractList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/CanAllotContractListHandler.ashx?fd=" + fromDate + "&td=" + toDate + "&ci=" + corpId + "&cno=" + contractNo;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return "<div style=\"overflow: hidden; text-overflow: ellipsis; padding-bottom: 2px; text-align: center; margin-right: 2px; margin-left: 4px; margin-top: 4px;\">"
                   + "<a target=\"_self\" href=\"CorpFundsAllotContractCreate.aspx?id=" + value + "\">分配</a>"
                   + "</div>";
            }
            $("#jqxGrid").jqxGrid(
            {
            ...
            $("#btnSearch").click(function () {
                ...
                var corpId = $("#selOutCorp").jqxComboBox("val");
                var contractNo = $("#txbContractNo").val();
                source.url = "Handler/CanAllotContractListHandler.ashx?fd=" + fromDate + "&td=" + toDate + "&ci=" + corpId + "&cno=" + contractNo;
