<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivableStockList.aspx.cs" Inherits="NFMTSite.Funds.ReceivableStockList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/ReceivableStockListHandler.ashx?e=" + empId + "&s=" + status;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"ReceivableStockDetail.aspx?id=" + value + "\">明细</a>";
                if (item.AllotStatus > statusEnum.已作废 && item.AllotStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"ReceivableStockUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#btnSearch").click(function () {
                var empId = $("#ddlEmpId").val();
                var status = $("#ddlAllotStatus").val();
                source.url = "Handler/ReceivableStockListHandler.ashx?e=" + empId + "&s=" + status;
