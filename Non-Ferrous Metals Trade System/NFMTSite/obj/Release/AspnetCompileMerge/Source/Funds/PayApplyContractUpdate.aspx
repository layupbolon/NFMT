<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayApplyContractUpdate.aspx.cs" Inherits="NFMTSite.Funds.PayApplyContractUpdate" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("Handler/PayApplyContractUpdateHandler.ashx", { PayApply: JSON.stringify(payApply), memo: $("#txbMemo").val(), deptId: $("#selApplyDept").val(), corpId: $("#selApplyCorp").jqxComboBox("val") },
                    function (result) {
