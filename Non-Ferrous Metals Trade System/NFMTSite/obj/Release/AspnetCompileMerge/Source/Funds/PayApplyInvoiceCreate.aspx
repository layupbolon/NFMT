<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayApplyInvoiceCreate.aspx.cs" Inherits="NFMTSite.Funds.PayApplyInvoiceCreate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {            
            ...
            invoiceListSource =
            {
                ...
                url: "Handler/PayApplyInvoiceListHandler.ashx"
            };
            ...
            $("#btnCreate").click(function () {
                ...
                $.post("Handler/PayApplyInvoiceCreateHandler.ashx", { Apply: JSON.stringify(apply), PayApply: JSON.stringify(payApply), Details: JSON.stringify(selects) },
                    function (result) {
        ...
        function bntAddOnClick(row) {
            ...
            if (inCorpId == 0) { inCorpId = item.InCorpId; }
            ...
            if (inCorpId != item.InCorpId) { alert("选中发票收票公司不一致"); return; }
            ...
            invoiceListSource.url = "Handler/PayApplyInvoiceListHandler.ashx?ids=" + ids;
