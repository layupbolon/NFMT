<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentContractCreate.aspx.cs" Inherits="NFMTSite.Funds.PaymentContractCreate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#selPayMode").jqxDropDownList({ source: payModeDataAdapter, displayMember: "DetailName", valueMember: "StyleDetailId", width: 100, height: 25  });
            ...
            $("#jqxPayApplyExpander").jqxValidator({
                rules:
                    [
                        ...
                        {
                            input: "#txbpayBala", message: "付款金额不能小于0或大于申请金额", action: "valueChanged,keyup,blur", rule: function (input, commit) {
            ...
            $("#btnCreate").click(function () {
                ...
                $.post("Handler/PaymentContractCreateHandler.ashx", { Payment: JSON.stringify(payment) },
                    function (result) {
                        var obj = JSON.parse(result);
                        if (obj.ResultStatus.toString() == "0") {
                            AjaxFileUpload(fileIds, obj.ReturnValue, AttachTypeEnum.PaymentAttach);
                        }
                        alert(obj.Message);
...
<body>
    ...
    <NFMT:Attach runat="server" ID="attach1" AttachStyle="Create" AttachType="PaymentAttach" />
