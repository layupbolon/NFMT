<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FundsCurrentByStock.aspx.cs" Inherits="NFMTSite.Report.FundsCurrentByStock" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/FundsCurrentByStockReportHandler.ashx?in=" + inCorpId + "&out=" + outCorpId + "&s=" + startDate + "&e=" + endDate;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "当期入库金额", datafield: "LastIssueBala", cellsformat: "d" },
                  { text: "当期收款金额", datafield: "LastCashInBala", cellsformat: "d" },
                  { text: "当期出库金额", datafield: "LastCollectBala", cellsformat: "d" },
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/FundsCurrentByStockReportHandler.ashx?in=" + inCorpId + "&out=" + outCorpId + "&s=" + startDate + "&e=" + endDate;
            ...
            $("#btnExcel").click(function () {
                ...
                document.location.href = "ExportExcel.aspx?rt=360&in=" + inCorpId + "&out=" + outCorpId + "&s=" + startDate + "&e=" + endDate;
