<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StopLossContractCreate.aspx.cs" Inherits="NFMTSite.DoPrice.StopLossContractCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //止损重量
            $("#txbStopLossWeight").jqxNumberInput({ height: 25, min: 0, decimalDigits: 4, width: 160, spinButtons: true, symbol: "<%=this.measureUnit.MUName%>", symbolPosition: "right" });
            ...
            $("#ddlExchangeId").jqxDropDownList({ source: exchangeDataAdapter, displayMember: "ExchangeName", valueMember: "ExchangeId", width: 130, height: 25, autoDropDownHeight: true});
            ...
            $("#btnCreate").on("click", function () {
                ...
                $.post("Handler/StopLossCreateHandler.ashx", {
...
<body>
    ...
    <div style="width: 80%; text-align: center;">
        <input type="button" id="btnCreate" value="止损" style="width: 125px; height: 25px;" />&nbsp;&nbsp;&nbsp;&nbsp;
                    <a target="_self" runat="server" href="StopLossCanApplyList.aspx" id="btnCancel">取消</a>&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
</body>
</html>
