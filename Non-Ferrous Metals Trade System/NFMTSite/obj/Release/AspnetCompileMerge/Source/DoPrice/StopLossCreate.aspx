<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StopLossCreate.aspx.cs" Inherits="NFMTSite.DoPrice.StopLossCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var selectItems = $("#hidDetailsId").val();

            var splitItem = selectItems.split(',');
...
<body>
    ...
    <div id="jqxCanStopLossStockExpander" style="float: left; margin: 0px 5px 5px 5px;">
        <div>
            可止损库存信息<input type="hidden" id="hidDetailsId" runat="server" />
        </div>
        <div>
