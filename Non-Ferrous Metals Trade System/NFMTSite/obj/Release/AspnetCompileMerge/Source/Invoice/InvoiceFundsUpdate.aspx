<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceFundsUpdate.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceFundsUpdate" %>
        ...
        $(document).ready(function () {
            ...
            $("#btnUpdate").click(function () {
                ...
                var invoiceFunds = {
                    ...
                    InvoiceId: "<%=this.curFundsInvoice.InvoiceId%>",
                ...
                $.post("Handler/InvoiceFundsUpdateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceFunds: JSON.stringify(invoiceFunds) },
                    function (result) {
                        var id = "<%=this.curInvoice.InvoiceId%>";
            ...
            function bntRemoveOnClick(row) {
                ...
                $.post("../Files/Handler/AttachUpdateStatusHandler.ashx", { aid: item.AttachId, s: statusEnum.已作废 },
                        function (result) {
                            attachSource.url = "../Files/Handler/GetAttachListHandler.ashx?cid=" + "<%=this.curInvoice.InvoiceId%>" + "&s=" + statusEnum.已生效 + "&t=" + AttachTypeEnum.InvoiceAttach;
