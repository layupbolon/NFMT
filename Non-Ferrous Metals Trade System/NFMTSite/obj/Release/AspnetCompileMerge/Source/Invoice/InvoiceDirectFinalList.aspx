<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceDirectFinalList.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceDirectFinalList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/InvoiceDirectFinalListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/InvoiceDirectFinalListHandler.ashx?s=" + status + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
