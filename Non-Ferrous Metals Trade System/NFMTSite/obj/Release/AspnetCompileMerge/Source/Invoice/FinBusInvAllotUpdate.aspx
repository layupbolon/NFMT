<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinBusInvAllotUpdate.aspx.cs" Inherits="NFMTSite.Invoice.FinBusInvAllotUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var bIds = "<%=this.bIds%>";
            var splitItem = bIds.split(",");
            for (i = 0; i < splitItem.length; i++) {
                if (splitItem[i].length > 0) {
                    BusinessInvoiceIds.push(parseInt(splitItem[i]));
                }
            }
            ...
            canAllotSource =
            {
                ...
                url: "Handler/FinBusInvAllotBusInvListHandler.ashx?c=" + "<%=this.curInvoice.CurrencyId%>" + "&dir=" + "<%=this.curInvoice.InvoiceDirection%>" + "&outCorpId=" + "<%=this.curInvoice.OutCorpId%>" + "&inCorpId=" + "<%=this.curInvoice.InCorpId%>" + "&bIds=" + bIds
            };
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("Handler/FinBusInvAllotUpdateHandler.ashx", {
