<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceInvoiceCreate.aspx.cs" Inherits="NFMTSite.Invoice.FinanceInvoiceCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#ddlOuterCorp").jqxComboBox({ source: corpDataAdapter, displayMember: "CorpName", valueMember: "CorpId", height: 25 });

            //收票公司
            corpSource.url = corpUrl + "<%=this.inSelf%>";
            var corpDataAdapter = new $.jqx.dataAdapter(corpSource);
            $("#ddlInnerCorp").jqxComboBox({ source: corpDataAdapter, displayMember: "CorpName", valueMember: "CorpId", height: 25 });

            //币种 
            var cySource = { datatype: "json", url: "../BasicData/Handler/CurrencDDLHandler.ashx", async: false };
            var cyDataAdapter = new $.jqx.dataAdapter(cySource);
            $("#ddlCurrency").jqxComboBox({ source: cyDataAdapter, displayMember: "CurrencyName", valueMember: "CurrencyId", width: 100, height: 25, autoDropDownHeight: true });
                ...
                columns: [
                  ...
                  { text: "净量", datafield: "NetAmountName" },
                  {
                      text: "操作", datafield: "Edit", columntype: "button", width: 90, cellsrenderer: function () {
                          ...
                          var integerAmount = $("#txbIntegerAmount").jqxNumberInput("val");
                          $("#txbIntegerAmount").jqxNumberInput("val", Math.round((integerAmount + item.IntegerAmount) * 10000) / 10000);
                          var netAmount = $("#txbNetAmount").jqxNumberInput("val");
            ...
            //发票金额
            $("#txbInvoiceBala").jqxNumberInput({ height: 25, max: 999999999, min: 0, digits: 9, decimalDigits: 2, width: 180, spinButtons: true });
            ...
            function FinInvoiceCreate(isAudit) {
                ...
                $.post("Handler/FinanceInvoiceCreateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceFunds: JSON.stringify(invoiceFunds), iids: iids },
                    function (result) {
            ...
            $("#btnCreate").click(function () { FinInvoiceCreate(false); });
            $("#btnAudit").click(function () { FinInvoiceCreate(true); });
        });
    </script>
