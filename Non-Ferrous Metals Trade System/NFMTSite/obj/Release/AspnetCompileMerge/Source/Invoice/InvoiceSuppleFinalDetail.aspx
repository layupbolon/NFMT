<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSuppleFinalDetail.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceSuppleFinalDetail" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnInvalid").on("click", function () {
                ...
                $.post("Handler/InvoiceSuppleFinalStatusHandler.ashx", { ii: "<%=this.curSuppleInvoice.BusinessInvoiceId%>", oi: operateId },
                    function (result) {
                        alert(result);
