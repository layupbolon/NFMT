<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceReplaceFinalUpdate.aspx.cs" Inherits="NFMTSite.Invoice.InvoiceReplaceFinalUpdate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#txbUnitPrice").on("valueChanged", function (event) {
                ...
                var sumAmount = 0;
                for (i = 0; i < repStocks.length; i++) {
                    var item = repStocks[i];

                    sumAmount += item.NetAmount;
                    var stockBala = Math.round((item.NetAmount * gapPrice) * 100) / 100;
                    item.Bala = stockBala;
                }
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("Handler/InvoiceReplaceFinalUpdateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceBusiness: JSON.stringify(invoiceBusiness), Details: JSON.stringify(rows) },
                    function (result) {
