<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuthGroupCreate.aspx.cs" Inherits="NFMTSite.User.AuthGroupCreate" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/AuthGroupCreateHandler.ashx", { authGroup: JSON.stringify(authGroup) },
                function (result) {
