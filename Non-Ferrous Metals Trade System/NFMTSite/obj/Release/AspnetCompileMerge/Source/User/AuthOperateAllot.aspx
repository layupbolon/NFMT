<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuthOperateAllot.aspx.cs" Inherits="NFMTSite.User.AuthOperateAllot" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var cellsrenderer = function (row, columnfield, value) {
                ...
                cellHtml += "<a target=\"_self\" href=\"AuthOperateAllotDetail.aspx?id=" + value + "\">选择员工</a>";
                cellHtml += "</div>";
                return cellHtml;
            }
