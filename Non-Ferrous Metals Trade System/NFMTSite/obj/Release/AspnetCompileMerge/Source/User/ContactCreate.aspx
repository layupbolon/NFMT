<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactCreate.aspx.cs" Inherits="NFMTSite.User.ContactCreate" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/ContactCreateHandler.ashx", {
        ...
        <div id="layOutDiv">
            <ul>
                <li>
                    ...
                    <span>
                        <input type="text" id="txbContactName" runat="server" />
                    </span></li>
                <li>
