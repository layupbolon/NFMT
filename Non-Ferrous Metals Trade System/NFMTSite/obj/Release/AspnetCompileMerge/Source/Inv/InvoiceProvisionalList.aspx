<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalList.aspx.cs" Inherits="NFMTSite.Inv.InvoiceProvisionalList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "../Invoice/Handler/InvoiceProvisionalListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "../Invoice/Handler/InvoiceProvisionalListHandler.ashx?s=" + status + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
