<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSuppleFinalUpdate.aspx.cs" Inherits="NFMTSite.Inv.InvoiceSuppleFinalUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            receiptStocks = receiptDataAdapter.records;
            ...
            //selOutCorp 对方公司
            var outCorpUrl = "../User/Handler/CorpDDLHandler.ashx?isSelf=0&SubId="+"<%=this.curSuppleInvoice.SubContractId%>";
            ...
            //selInCorp 我方公司
            var inCorpUrl = "../User/Handler/CorpDDLHandler.ashx?isSelf=1&SubId="+"<%=this.curSuppleInvoice.SubContractId%>";
            ...
            $("#txbUnitPrice").val(<%=this.curSuppleInvoice.UnitPrice%>);
            ...
            $("#selAsset").val(<%=this.curSuppleInvoice.AssetId%>);
            $("#selUnit").val(<%=this.curSuppleInvoice.MUId%>);
            ...
            $("#txbIntegerAmount").val(<%=this.curSuppleInvoice.IntegerAmount%>);
            $("#txbNetAmount").val(<%=this.curSuppleInvoice.NetAmount%>);
            ...
            $("#btnUpdate").click(function () {
                ...
                var invoiceBusiness = {
                    BusinessInvoiceId:"<%=this.curSuppleInvoice.BusinessInvoiceId%>",
                ...
                $.post("../Invoice/Handler/InvoiceSuppleFinalUpdateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceBusiness: JSON.stringify(invoiceBusiness),Details:JSON.stringify(rows) },
                    function (result) {
...
<body>
    ...
    <div style="width: 80%; text-align: center;">
        <input type="button" id="btnUpdate" value="修改补零终票" style="width: 125px; height: 25px;" />&nbsp;&nbsp;&nbsp;&nbsp;
