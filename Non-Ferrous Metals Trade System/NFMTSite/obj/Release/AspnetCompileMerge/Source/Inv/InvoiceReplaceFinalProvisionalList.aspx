<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceReplaceFinalProvisionalList.aspx.cs" Inherits="NFMTSite.Inv.InvoiceReplaceFinalProvisionalList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "../Invoice/Handler/InvoiceProvisionalListHandler.ashx?s=" + statusEnum.已生效;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"InvoiceReplaceFinalCreate.aspx?id=" + value + "\">替临</a>";
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "../Invoice/Handler/InvoiceProvisionalListHandler.ashx?s=" + statusEnum.已生效 + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
