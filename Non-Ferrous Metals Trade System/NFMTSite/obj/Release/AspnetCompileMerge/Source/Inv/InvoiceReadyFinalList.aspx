<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceReadyFinalList.aspx.cs" Inherits="NFMTSite.Inv.InvoiceReadyFinalList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "../Invoice/Handler/InvoiceReadyFinalListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
                ...
                type: "GET",
                sortcolumn: "fi.BusinessInvoiceId",
                sortdirection: "desc",
                formatdata: function (data) {
                    data.pagenum = data.pagenum || 0;
                    data.pagesize = data.pagesize || 10;
                    data.sortdatafield = data.sortdatafield || "fi.BusinessInvoiceId";
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"InvoiceSuppleFinalCreate.aspx?id=" + value + "\">补零</a>";
                cellHtml += "</div>";
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "../Invoice/Handler/InvoiceReadyFinalListHandler.ashx?" + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
