<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractOutDetail.aspx.cs" Inherits="NFMTSite.Contract.ContractOutDetail" %>
...
<body>
    ...
    <div id="jqxValidator">
        ...
        <NFMT:Attach runat="server" ID="attach1" AttachStyle="查看" AttachType="ContractAttach" />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#selInCorp").jqxComboBox({ source: inCorpDataAdapter, displayMember: "CorpName", valueMember: "CorpId", multiSelect: true, searchMode: "containsignorecase", height: 25, width: 500, disabled: true });
        ...
        $("#btnInvalid").on("click", function () {
            ...
            $.post("Handler/ContractOutStatusHandler.ashx", { id: "<% = this.curContract.ContractId%>", oi: operateId },
                    function (result) {
