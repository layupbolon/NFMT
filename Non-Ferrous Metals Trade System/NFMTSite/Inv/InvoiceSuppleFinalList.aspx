<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSuppleFinalList.aspx.cs" Inherits="NFMTSite.Inv.InvoiceSuppleFinalList" %>
<!DOCTYPE html>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "../Invoice/Handler/InvoiceSuppleFinalListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
