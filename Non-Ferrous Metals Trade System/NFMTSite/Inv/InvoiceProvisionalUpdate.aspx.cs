...
{
    public partial class InvoiceProvisionalUpdate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ver.JudgeOperate(this.Page, 115, new List<NFMT.Common.OperateEnum>() { NFMT.Common.OperateEnum.修改 });
                ...
                this.navigation1.Routes.Add(string.Format("临票修改", invoiceDirection), string.Empty);
        ...
        public void SelectJson(NFMT.Invoice.Model.BusinessInvoice businessInvoice, NFMT.Invoice.InvoiceDirectionEnum direction)
        {
            ...
            select = bll.GetProvisionalContractStockListSelect(pageIndex, pageSize, orderStr, businessInvoice.SubContractId, businessInvoice.BusinessInvoiceId, false, false);
