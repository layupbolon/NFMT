<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceDirectFinalUpdate.aspx.cs" Inherits="NFMTSite.Inv.InvoiceDirectFinalUpdate" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnUpdate").click(function () {
                ...
                $.post("../Invoice/Handler/InvoiceDirectFinalUpdateHandler.ashx", { Invoice: JSON.stringify(invoice), InvoiceBusiness: JSON.stringify(invoiceBusiness),Details:JSON.stringify(rows) },
                    function (result) {
