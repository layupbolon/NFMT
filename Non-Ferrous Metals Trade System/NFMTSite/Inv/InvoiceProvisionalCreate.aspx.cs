    ...
    public partial class InvoiceProvisionalCreate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ver.JudgeOperate(this.Page, 115, new List<NFMT.Common.OperateEnum>() { NFMT.Common.OperateEnum.录入 });
                ...
                //定价合约
                if (contract.PriceMode == (int)NFMT.Contract.PriceModeEnum.定价)
                    this.curUnitPrice = contractPrice.FixedPrice;                
                else
                    this.curUnitPrice = contractPrice.AlmostPrice;
