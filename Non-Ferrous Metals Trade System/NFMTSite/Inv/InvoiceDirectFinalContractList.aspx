<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceDirectFinalContractList.aspx.cs" Inherits="NFMTSite.Inv.InvoiceDirectFinalContractList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#txbContractCode").jqxInput({ height: 22, width: 120 });
            ...
            var url = "../Invoice/Handler/InvoiceDirectFinalContractListHandler.ashx?tradeDir=" + tradeDir + "&sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
               ...
               [
                   ...
                   { name: "TradeDirection", type: "number" },
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                if (item.TradeDirection == "<%=(int)NFMT.Contract.TradeDirectionEnum.Buy%>") {
                    cellHtml += "<a target=\"_self\" href=\"InvoiceDirectFinalCreate.aspx?d=" + "<%=(int)NFMT.Invoice.InvoiceDirectionEnum.收取%>" + "&id=" + value + "\">发票收取";
                }
                else if (item.TradeDirection == "<%=(int)NFMT.Contract.TradeDirectionEnum.Sell%>") {
                    cellHtml += "<a target=\"_self\" href=\"InvoiceDirectFinalCreate.aspx?d=" + "<%=(int)NFMT.Invoice.InvoiceDirectionEnum.开具%>" + "&id=" + value + "\">发票开具";
                }
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: "操作", datafield: "SubId", cellsrenderer: cellsrenderer, width: 100, sortable: false }
                ]
            });
            ...
            $("#btnSearch").click(function () {
                ...
                var toDate = $("#txbToCreateDate").jqxDateTimeInput("getText");
                var tradeDir = $("#selTradeDirection").jqxDropDownList("val");
                source.url = "../Invoice/Handler/InvoiceDirectFinalContractListHandler.ashx?tradeDir=" + tradeDir + "&sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
