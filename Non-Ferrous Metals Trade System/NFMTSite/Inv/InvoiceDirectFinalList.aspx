<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceDirectFinalList.aspx.cs" Inherits="NFMTSite.Inv.InvoiceDirectFinalList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "../Invoice/Handler/InvoiceDirectFinalListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"InvoiceDirectFinalDetail.aspx?id=" + value + "\">明细</a>";

                if (item.InvoiceStatus > statusEnum.已关闭 && item.InvoiceStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"InvoiceDirectFinalUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "../Invoice/Handler/InvoiceDirectFinalListHandler.ashx?s=" + status + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="InvoiceDirectFinalContractList.aspx" id="btnAdd">直接终票新增</a>
                </li>
            </ul>
        </div>
    </div>
