<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoStockOrderList.aspx.cs" Inherits="NFMTSite.Document.NoStockOrderList" %>
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="OrderContractList.aspx" id="btnAddOrder">新建无配货制单指令</a>
                </li>
            </ul>
        </div>
    </div>
