...
{
    /// <summary>
    /// OrderReplaceListHandler 的摘要说明
    /// </summary>
    public class OrderReplaceListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetReplaceOrdersModel(pageIndex, pageSize, orderStr, beginDate, endDate, contractNo, outerCorp, status);
