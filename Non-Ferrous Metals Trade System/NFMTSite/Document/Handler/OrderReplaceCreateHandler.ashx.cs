...
{
    /// <summary>
    /// OrderReplaceCreateHandler 的摘要说明
    /// </summary>
    public class OrderReplaceCreateHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            result = bll.CreateReplaceOrder(user, order, stockInvoices, detail, isSubmitAudit);
