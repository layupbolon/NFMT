...
{
    /// <summary>
    /// OrderStockListHandler 的摘要说明
    /// </summary>
    public class OrderStockListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            int orderId = 0;
            if (string.IsNullOrEmpty(context.Request.QueryString["orderId"]) || !int.TryParse(context.Request.QueryString["orderId"], out orderId))
                orderId = 0;
            ...
            NFMT.Common.SelectModel select = bll.GetOrderSalesStockSelect(pageIndex, pageSize, orderStr, sids, contractId, orderId, dids, refNo, ownCorpId);
