...
{
    /// <summary>
    /// CurrencyStatusHandler 的摘要说明
    /// </summary>
    public class CurrencyStatusHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Data.BLL.CurrencyBLL cll = new NFMT.Data.BLL.CurrencyBLL();
            NFMT.Data.Model.Currency crey = new NFMT.Data.Model.Currency()
            {
                CurrencyId = id,
