...
{
    /// <summary>
    /// BankStatusHandler 的摘要说明
    /// </summary>
    public class BankStatusHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Data.BLL.BankBLL cll = new NFMT.Data.BLL.BankBLL();
            NFMT.Data.Model.Bank crey = new NFMT.Data.Model.Bank()
            {
                BankId = id,
