...
{
    public partial class PricingUpdate : System.Web.UI.Page
    {
        public int mUId = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                result = pricingDetailBLL.GetCanDoPriceApplyDetailIds(user, pricingId);
                if (result.ResultStatus != 0)
                    Response.Redirect(redirectUrl);
                this.hidDetailsIdUp.Value = result.ReturnValue.ToString();
