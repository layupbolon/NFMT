<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PricingList.aspx.cs" Inherits="NFMTSite.DoPrice.PricingList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //绑定Grid
            var url = "Handler/PricingListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                if (item.DetailRow == 0) {
                    cellHtml += "<a target=\"_self\" href=\"PricingContractDetail.aspx?id=" + value + "\">查看</a>";
                }
                else {
                    cellHtml += "<a target=\"_self\" href=\"PricingDetail.aspx?id=" + value + "\">查看</a>";
                }

                if (item.PricingStatus > statusEnum.已关闭 && item.PricingStatus < statusEnum.待审核) {
                    if (item.DetailRow == 0) {
                        cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"PricingContractUpdate.aspx?id=" + value + "\">修改</a>";
                    }
                    else {
                        cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"PricingUpdate.aspx?id=" + value + "\">修改</a>";
                    }
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/PricingListHandler.ashx?p=" + person + "&a=" + assetId + "&e=" + exchangeId + "&s=" + status + "&subNo=" + subNo;
    ...
    <div id="jqxExpander" style="float: left; margin: 0px 5px 5px 5px; padding-bottom: 10px;">
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    <span style="float: left;">点价状态：</span>
                    <div id="ddlPricingStatus" style="float: left;"></div>
                </li>
                <li>
                    <input type="button" id="btnSearch" value="查询" />
                    <a target="_self" runat="server" href="PricingCanDoPriceApplyList.aspx" id="btnAdd">点价</a>
                </li>
            </ul>
        </div>
    </div>
