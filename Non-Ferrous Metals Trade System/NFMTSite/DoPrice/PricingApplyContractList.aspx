<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PricingApplyContractList.aspx.cs" Inherits="NFMTSite.DoPrice.PricingApplyContractList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/PricingApplyContractListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"PricingApplyCreate.aspx?subId=" + value + "\">点价申请</a>"
                cellHtml += "</a>";
                cellHtml += "</div>";
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/PricingApplyContractListHandler.ashx?sn=" + subNo + "&oci=" + corpId + "&fd=" + fromDate + "&td=" + toDate;
