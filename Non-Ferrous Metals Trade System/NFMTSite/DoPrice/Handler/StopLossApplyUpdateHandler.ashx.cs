...
{
    /// <summary>
    /// StopLossApplyUpdateHandler 的摘要说明
    /// </summary>
    public class StopLossApplyUpdateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.Update(user, apply, stopLossApply, details);
                if (result.ResultStatus == 0)
                {
                    result.Message = "止损申请修改成功";
                }
            }
            catch (Exception ex)
            {
