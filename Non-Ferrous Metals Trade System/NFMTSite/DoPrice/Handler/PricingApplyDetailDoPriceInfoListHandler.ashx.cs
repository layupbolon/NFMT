...
{
    /// <summary>
    /// PricingApplyDetailDoPriceInfoListHandler 的摘要说明
    /// </summary>
    public class PricingApplyDetailDoPriceInfoListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetDoPriceInfoSelectModel(pageIndex, pageSize, orderStr, pricingApplyId);
