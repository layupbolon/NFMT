...
{
    /// <summary>
    /// PricingApplyDetailStockListHandler 的摘要说明
    /// </summary>
    public class PricingApplyDetailStockListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetDetailSelectModel(pageIndex, pageSize, orderStr, pricingApplyId);
