...
{
    /// <summary>
    /// PricingApplyContractListHandler 的摘要说明
    /// </summary>
    public class PricingApplyContractListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetCanApplyContractListSelect(pageIndex, pageSize, orderStr, subNo, outCorpId, fromDate, toDate);
