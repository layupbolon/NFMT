...
{
    /// <summary>
    /// PricingCanDoPriceListHandler 的摘要说明
    /// </summary>
    public class PricingCanDoPriceListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetCanDoPriceApplySelectModel(pageIndex, pageSize, orderStr, applyDept, fromDate, toDate, status);
