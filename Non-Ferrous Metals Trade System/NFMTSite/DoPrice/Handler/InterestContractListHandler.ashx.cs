...
{
    /// <summary>
    /// InterestContractListHandler 的摘要说明
    /// </summary>
    public class InterestContractListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetPledgeContractListSelect(pageIndex, pageSize, orderStr, subNo);
