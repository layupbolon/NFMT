...
{
    /// <summary>
    /// InterestListHandler 的摘要说明
    /// </summary>
    public class InterestListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(context.Request.QueryString["sortdatafield"]) && !string.IsNullOrEmpty(context.Request.QueryString["sortorder"]))
            {
                ...
                switch (sortDataField)
                {
                    ...
                    case "InCorpName":
                        ...
                        break;                    
                    case "StatusName":
                        sortDataField = "it.InterestStatus";
                        break;
                    case "TradeDirection":
            ...
            NFMT.Common.SelectModel select = bll.GetInterestsSelect(pageIndex, pageSize, orderStr, fromDate, toDate, status, inCorpId, outCorpId);
