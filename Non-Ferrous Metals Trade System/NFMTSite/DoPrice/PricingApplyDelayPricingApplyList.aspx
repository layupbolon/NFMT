<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PricingApplyDelayPricingApplyList.aspx.cs" Inherits="NFMTSite.DoPrice.PricingApplyDelayPricingApplyList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //绑定Grid
            var url = "Handler/PricingCanDelayListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"PricingApplyDelayCreate.aspx?id=" + value + "\">点价延期</a>";
                cellHtml += "</div>";
                return cellHtml;
            }
            $("#jqxGrid").jqxGrid(
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/PricingCanDelayListHandler.ashx?a=" + applyDept + "&f=" + fromDate + "&t=" + toDate;
