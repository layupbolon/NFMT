<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceConfirmCreate.aspx.cs" Inherits="NFMTSite.DoPrice.PriceConfirmCreate" %>
        ...
        $(document).ready(function () {
            ...
            $("#jqxConfirmStockLogsGrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  //{ text: "单位", datafield: "MUName", width: 45 },
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function PriceConfirmCreate(isAudit) {
                ...
                $.post("Handler/PriceConfirmCreateHandler.ashx", {
