...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //回执前净重
            $("#nbPreNetAmount").jqxNumberInput({ width: 120, height: 25, decimalDigits: 4, spinButtons: true, disabled: true });
            $("#nbPreNetAmount").jqxNumberInput("val", "<%=this.stockReceiptDetail.PreNetAmount%>");

            //回执后净重
            $("#nbReceiptAmount").jqxNumberInput({ width: 120, height: 25, decimalDigits: 4, spinButtons: true });
