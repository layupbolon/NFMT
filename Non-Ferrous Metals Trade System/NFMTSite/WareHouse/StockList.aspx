<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockList.aspx.cs" Inherits="NFMTSite.WareHouse.StockList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/StockListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                return "<div style=\"overflow: hidden; text-overflow: ellipsis; padding-bottom: 2px; text-align: center; margin-right: 2px; margin-left: 4px; margin-top: 4px;\"><a target=\"_self\" href=\"StockLogList.aspx?id=" + value + "\">查看流水</a></div>";;
            }
            $("#jqxgrid").jqxGrid(
            {
                width: "98%",
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/StockListHandler.ashx?sn=" + stockName + "&ci=" + corpId + "&sdb=" + fromDate + "&sde=" + toDate;
