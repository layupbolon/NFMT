<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockInContractUpdate.aspx.cs" Inherits="NFMTSite.WareHouse.StockInContractUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            rows = $("#jqxSelectGrid").jqxGrid("getrows");
            ...
            contractSource =
            {
                ...
                url: "Handler/StockInCanSelectContractListHandler.ashx?id="+"<%=this.curContractStockIn.ContractSubId%>"+"&stockId="+"<%=this.curStockIn.StockInId%>"
            };
            ...
            $("#btnAdd").click(function () {
                ...
                if (subId == 0) { alert("未选中任何子合约"); return; }
                if (!confirm("确认修改入库登记分配？")) { return; }

                $.post("Handler/StockInContractUpdateHandler.ashx", { SubId:subId,RefId:"<%=this.curContractStockIn.RefId%>" },
                   function (result) {
