<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PledgeCreate.aspx.cs" Inherits="NFMTSite.WareHouse.PledgeCreate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/PledgeStockInfoHandler.ashx?pid=" + "<%=this.pledgeApplyId%>";
            var formatedData = "";
            var totalrecords = 0;
            var Infosource =
            {
            ...
            $("#jqxPledgeGrid").jqxGrid(
            {
                ...
                for (i = 0; i < deletes.length; i++) {
                    ...
                    $(btnDelete).click({ value: val }, function (event) {
                        ...
                        //刷新列表
                        Infosource.url = "Handler/PledgeStockInfoHandler.ashx?pid=" + "<%=this.pledgeApplyId%>" + "&sids=" + sidsUp;
                        $("#jqxPledgeGrid").jqxGrid("updatebounddata", "rows");
                        source.url = "Handler/PledgeStockInfoHandler.ashx?pid=" + "<%=this.pledgeApplyId%>" + "&sids=" + sidsDown;
            ...
            var url = "Handler/PledgeStockInfoHandler.ashx?pid=" + "<%=this.pledgeApplyId%>" + "&sids=" + sidsDown;
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            $("#ddlPledgeBank").jqxComboBox("val", "<%=this.pledgeApply.PledgeBank%>");
            ...
            $("#btnAdd").on("click", function () {
                ...
                var pledge = {
                    PledgeApplyId: "<%=this.pledgeApply.PledgeApplyId%>",
                ...
                $.post("Handler/PledgeCreateHandler.ashx", {
                    ...
                    function (result) {
                        ...
                        if (obj.ResultStatus.toString() == "0") {
                            AjaxFileUpload(fileIds, obj.ReturnValue, AttachTypeEnum.PledgeAttach);
                        }
                        alert(obj.Message);
                        if (obj.ResultStatus.toString() == "0") {
...
<body>
    ...
    <NFMT:Attach runat="server" ID="attach1" AttachStyle="Create" AttachType="PledgeAttach" />
