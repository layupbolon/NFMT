...
{
    public partial class PreToRealDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string redirectUrl = string.Format("{0}WareHouse/PreToRealList.aspx", NFMT.Common.DefaultValue.NftmSiteName);
            ...
            if (!IsPostBack)
            {
                ...
                ver.JudgeOperate(this.Page, 129, new List<NFMT.Common.OperateEnum>() { NFMT.Common.OperateEnum.查询 });

                this.navigation1.Routes.Add("预入库转正式库存列表", redirectUrl);
                this.navigation1.Routes.Add("预入库转正式库存明细", string.Empty);
                ...
                this.attach1.BusinessIdValue = this.stock.StockId;
            }
        }
    }
}