<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockInDirectReady.aspx.cs" Inherits="NFMTSite.WareHouse.StockInDirectReady" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#ddlCustomType").jqxComboBox({ source: ddlStockTypedataAdapter, displayMember: "DetailName", valueMember: "StyleDetailId", width: 180, height: 25, autoDropDownHeight: true, selectedIndex: 0 });

            //入账公司
            var ddlCorpIdurl = "../User/Handler/AuthSelfCorpHandler.ashx";
            var ddlCorpIdsource = { datatype: "json", url: ddlCorpIdurl, async: false };
            var ddlCorpIddataAdapter = new $.jqx.dataAdapter(ddlCorpIdsource);
            $("#ddlCorpId").jqxComboBox({ source: ddlCorpIddataAdapter, displayMember: "CorpName", valueMember: "CorpId", width: 180, height: 25, autoDropDownHeight: true, searchMode: "containsignorecase" });
            ...
            function StockInCreate(isAudit) {
                ...
                $.post("Handler/StockInCreateHandler.ashx", { StockIn: JSON.stringify(stockInModel), IsInsertRef: 0, IsSubmitAudit: isAudit },
                    function (result) {
                        ...
                        if (obj.ResultStatus.toString() == "0") {
                            if (isAudit) {
                                AutoSubmitAudit(MasterEnum.预入库审核, JSON.stringify(obj.ReturnValue));
                            }
                        }
                        alert(obj.Message);
                        if (obj.ResultStatus.toString() == "0") {
