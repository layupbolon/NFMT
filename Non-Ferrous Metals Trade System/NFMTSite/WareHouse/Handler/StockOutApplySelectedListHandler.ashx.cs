...
{
    /// <summary>
    /// StockOutApplySelectedListHandler 的摘要说明
    /// </summary>
    public class StockOutApplySelectedListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = applyBLL.GetOutApplySelectedSelect(pageIndex, pageSize, orderStr, sids,stockOutApplyId);
