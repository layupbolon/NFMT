...
{
    /// <summary>
    /// StockOutApplyListHandler 的摘要说明
    /// </summary>
    public class StockOutApplyListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = stockOutApplyBLL.GetSelectModel(pageIndex, pageSize, orderStr, contractCode, fromDate, toDate, status);
