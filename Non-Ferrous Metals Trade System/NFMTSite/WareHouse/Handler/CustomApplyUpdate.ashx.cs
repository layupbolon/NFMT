...
{
    /// <summary>
    /// CustomApplyUpdate 的摘要说明
    /// </summary>
    public class CustomApplyUpdate : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.Update(user, apply, customsClearanceApply, customsApplyDetails);
                if (result.ResultStatus == 0)
                {
                    result.Message = "报关申请修改成功";
                }
            }
            catch (Exception ex)
            {
