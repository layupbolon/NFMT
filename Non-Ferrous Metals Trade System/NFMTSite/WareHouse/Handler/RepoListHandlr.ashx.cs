...
{
    /// <summary>
    /// RepoListHandlr 的摘要说明
    /// </summary>
    public class RepoListHandlr : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                if (!int.TryParse(context.Request.QueryString["m"], out repoer))
                    repoer = 0;
            }
            ...
            NFMT.Common.SelectModel select = repoBLL.GetSelectModel(pageIndex, pageSize, orderStr, status, repoer);
