...
{
    /// <summary>
    /// SplitDocUpdateHandler 的摘要说明
    /// </summary>
    public class SplitDocUpdateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int splitDocId = 0;
            if (string.IsNullOrEmpty(context.Request.Form["splitDocId"]) || !int.TryParse(context.Request.Form["splitDocId"], out splitDocId) || splitDocId <= 0)
            {
                context.Response.Write("拆单序号错误");
            ...
            try
            {
                ...
                result = bll.Update(user, splitDocId, stockId, splitDocDetails);
