...
{
    /// <summary>
    /// StockReceiptingListHandler 的摘要说明
    /// </summary>
    public class StockReceiptingListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetReceiptingStockListSelect(pageIndex, pageSize, orderStr, subId, receiptId, sids);
