...
{
    /// <summary>
    /// StockCanReceiptListHandler 的摘要说明
    /// </summary>
    public class StockCanReceiptListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetCanReceiptStockListSelect(pageIndex, pageSize, orderStr, subId, sids,receiptId);
