...
{
    /// <summary>
    /// StockReceiptedListHandler 的摘要说明
    /// </summary>
    public class StockReceiptedListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetReceiptedStockListSelect(pageIndex, pageSize, orderStr,subId,receiptId);
