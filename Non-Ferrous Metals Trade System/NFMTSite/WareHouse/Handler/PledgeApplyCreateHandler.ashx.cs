...
{
    /// <summary>
    /// PledgeApplyCreateHandler 的摘要说明
    /// </summary>
    public class PledgeApplyCreateHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = bll.PledgeApplyCreateHandle(user, apply, pledgeApply, details);
                if (result.ResultStatus == 0)
                    result.Message = "质押申请新增成功";
            }
            catch (Exception ex)
            {
