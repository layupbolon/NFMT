...
{
    /// <summary>
    /// StockInListHandler 的摘要说明
    /// </summary>
    public class StockInListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = stockInBLL.GetSelectModel(pageIndex, pageSize, orderStr, stockName, status, fromDate, toDate);
