...
{
    /// <summary>
    /// StockOutedListHandler 的摘要说明
    /// </summary>
    public class StockOutedListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(context.Request.QueryString["sortdatafield"]) && !string.IsNullOrEmpty(context.Request.QueryString["sortorder"]))
            {
                ...
                switch (sortDataField)
                {
                    ...
                    case "DetailId":
                        ...
                        break;
                    case "StockOutAmount":
                        sortDataField = "sod.StockOutAmount";
                        break;
                }
            ...
            NFMT.Common.SelectModel select = stockOutBLL.GetStockOutedSelect(pageIndex, pageSize, orderStr,stockOutApplyId);
