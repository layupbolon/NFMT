...
{
    /// <summary>
    /// SplitDocListHandler 的摘要说明
    /// </summary>
    public class SplitDocListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetSelectModel(pageIndex, pageSize, orderStr, person, fromDate, toDate, refNo, status);
