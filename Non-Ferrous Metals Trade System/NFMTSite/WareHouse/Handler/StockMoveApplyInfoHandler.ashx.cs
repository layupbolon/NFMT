...
{
    /// <summary>
    /// StockMoveApplyInfoHandler 的摘要说明
    /// </summary>
    public class StockMoveApplyInfoHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetStockMoveApplyInfoSelect(pageIndex, pageSize, orderStr, sids, applyId, mode);
