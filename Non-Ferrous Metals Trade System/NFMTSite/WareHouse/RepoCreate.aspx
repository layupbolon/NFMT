<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepoCreate.aspx.cs" Inherits="NFMTSite.WareHouse.RepoCreate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var url = "Handler/RepoStockInfoHandler.ashx?pid=" + "<%=this.repoApplyId%>";
            var formatedData = "";
            var totalrecords = 0;
            var Infosource =
            {
            ...
            $("#btnAdd").on("click", function () {
                ...
                $.post("Handler/RopoCreateHandler.ashx", {
                    id: $("#hidid").val(),
                    sids: sids,
                    memo: $("#txbMemo").val()
                },
        ...
        <div id="layOutDiv">
            <ul>
                ...
                <li>
                    ...
                    <span><a target="_self" runat="server" href="CanRepoApplyList.aspx" id="btnCancel" style="margin-left: 10px">取消</a></span>
                </li>
            </ul>
        </div>
    </div>
