...
// 文件名：ContractCorporationDetail.cs
// 文件功能描述：合约抬头明细dbo.Con_ContractCorporationDetail实体类。
// 创建人：CodeSmith
// 创建时间： 2014年7月24日
----------------------------------------------------------------*/
...
{
    /// <summary>
    /// 合约抬头明细dbo.Con_ContractCorporationDetail实体类。
    /// </summary>
    [Serializable]
    public class ContractCorporationDetail : IModel
    {
        #region 字段
        ...
        private string tableName = "dbo.Con_ContractCorporationDetail";
        #endregion

        #region 构造函数

        public ContractCorporationDetail()
        {
        }
        ...
        private string dalName = "NFMT.Contract.DAL.ContractCorporationDetailDAL";
