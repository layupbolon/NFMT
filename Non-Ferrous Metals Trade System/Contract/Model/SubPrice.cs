...
// 文件名：SubPrice.cs
// 文件功能描述：子合约价格明细dbo.Con_SubPrice实体类。
// 创建人：CodeSmith
// 创建时间： 2015年2月4日
----------------------------------------------------------------*/
...
{
    /// <summary>
    /// 子合约价格明细dbo.Con_SubPrice实体类。
    /// </summary>
    [Serializable]
    public class SubPrice : IModel
    {
        #region 字段

        private int subPriceId;
        private int subId;
        ...
        private string tableName = "dbo.Con_SubPrice";
        #endregion
        ...
        /// 合约价格序号
        /// </summary>
        public int SubPriceId
        {
            get { return subPriceId; }
            set { subPriceId = value; }
        }
        ...
        public int Id
        {
            get { return this.subPriceId; }
            set { this.subPriceId = value; }
        }
        ...
        private string dalName = "NFMT.Contract.DAL.SubPriceDAL";
