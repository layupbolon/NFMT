...
// 文件名：DocumentStock.cs
// 文件功能描述：制单库存明细dbo.Doc_DocumentStock实体类。
// 创建人：CodeSmith
// 创建时间： 2014年11月25日
----------------------------------------------------------------*/
...
{
    /// <summary>
    /// 制单库存明细dbo.Doc_DocumentStock实体类。
    /// </summary>
    [Serializable]
    public class DocumentStock : IModel
    {
        #region 字段
        ...
        private int orderId;
        private int orderStockDetailId;
        private int stockId;
        ...
        private string tableName = "dbo.Doc_DocumentStock";
        #endregion
        ...
        /// 指令库存明细序号
        /// </summary>
        public int OrderStockDetailId
        {
            get { return orderStockDetailId; }
            set { orderStockDetailId = value; }
        }
        ...
        private string dalName = "NFMT.Document.DAL.DocumentStockDAL";
