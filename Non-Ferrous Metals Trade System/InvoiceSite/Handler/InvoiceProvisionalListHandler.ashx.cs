...
namespace InvoiceSite.Handler
{
    /// <summary>
    /// InvoiceProvisionalListHandler 的摘要说明
    /// </summary>
    public class InvoiceProvisionalListHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            NFMT.Common.SelectModel select = bll.GetProvisionalSelect(pageIndex, pageSize, orderStr, fromDate, toDate, status, inCorpId, outCorpId);
