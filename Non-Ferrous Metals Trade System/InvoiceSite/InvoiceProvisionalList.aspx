<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceProvisionalList.aspx.cs" Inherits="InvoiceSite.InvoiceProvisionalList" %>
...
<head id="Head1" runat="server">
    ...
    <title>临票列表</title>
    <link rel="stylesheet" href="http://release.maikegroup.com/jqwidgets/styles/jqx.base.css" type="text/css" />
    <link rel="stylesheet" href="http://release.maikegroup.com/jqwidgets/styles/jqx.metro.css" media="screen" />
    <link rel="stylesheet" href="http://release.maikegroup.com/css/Layout.css" type="text/css" />
    <script type="text/javascript" src="http://release.maikegroup.com/jqwidgets/scripts/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="http://release.maikegroup.com/jqwidgets/scripts/jqx-all.js"></script>
    <script type="text/javascript" src="http://release.maikegroup.com/js/Utility.js"></script>
    <script type="text/javascript" src="http://release.maikegroup.com/js/status.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //对方公司
            var outCorpUrl = "http://site.maikegroup.com/User/Handler/CorpDDLHandler.ashx?isSelf=0&nfmt="+"<%=this.CurrentUser.CookieValue%>";
            var outCorpSource = { datatype: "json", url: outCorpUrl, async: true };
            ...
            //我方公司            
            var inCorpUrl = "http://site.maikegroup.com/User/Handler/CorpDDLHandler.ashx?isSelf=1";
            var inCorpSource = { datatype: "json", url: inCorpUrl, async: true };
            ...
            var url = "Handler/InvoiceProvisionalListHandler.ashx";
            var formatedData = "";
            var totalrecords = 0;
            var source =
            {
            ...
            var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties) {
                ...
                cellHtml += "<a target=\"_self\" href=\"InvoiceProvisionalDetail.aspx?id=" + value + "\">明细</a>";

                if (item.InvoiceStatus > statusEnum.已关闭 && item.InvoiceStatus < statusEnum.待审核) {
                    cellHtml += "&nbsp;&nbsp;&nbsp<a target=\"_self\" href=\"InvoiceProvisionalUpdate.aspx?id=" + value + "\">修改</a>";
                }
                else {
                    cellHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            ...
            $("#btnSearch").click(function () {
                ...
                source.url = "Handler/InvoiceProvisionalListHandler.ashx?s=" + status + "&ic=" + inCorp + "&oc=" + outCorp + "&fd=" + fromDate + "&td=" + toDate;
        ...
        <div class="SearchExpander">
            <ul>
                ...
                <li>
                    ...
                    <a target="_self" runat="server" href="InvoiceProvisionalContractList.aspx" id="btnAdd">临票新增</a>
                </li>
            </ul>
        </div>
    </div>
